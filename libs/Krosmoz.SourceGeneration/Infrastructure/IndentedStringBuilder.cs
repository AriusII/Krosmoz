...
namespace Krosmoz.SourceGeneration.Infrastructure;
...
public sealed class IndentedStringBuilder
{
    ...
    /// <summary>
    /// Converts the content of the builder to a <see cref="SourceText"/> object using UTF-8 encoding.
    /// </summary>
    /// <returns>A <see cref="SourceText"/> object representing the builder's content.</returns>
