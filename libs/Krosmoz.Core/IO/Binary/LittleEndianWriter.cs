...
/// <summary>
/// A utility class for writing binary data in Little-Endian format.
/// </summary>
public sealed class LittleEndianWriter : IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LittleEndianWriter"/> class with an empty buffer.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LittleEndianWriter"/> class with a specified capacity.
    /// </summary>
    /// <param name="capacity">The initial capacity of the buffer.</param>
    public LittleEndianWriter(int capacity)
    {
    ...
    /// <summary>
    /// Writes a signed 16-bit integer in Little-Endian format to the buffer.
    /// </summary>
    ...
    /// <summary>
    /// Writes a signed 32-bit integer in Little-Endian format to the buffer.
    /// </summary>
    ...
    /// <summary>
    /// Writes an unsigned 64-bit integer in Little-Endian format to the buffer.
    /// </summary>
    ...
    /// <summary>
    /// Writes a signed 64-bit integer in Little-Endian format to the buffer.
    /// </summary>
    ...
    /// <summary>
    /// Writes a single-precision floating-point number in Little-Endian format to the buffer.
    /// </summary>
    ...
    /// <summary>
    /// Writes a double-precision floating-point number in Little-Endian format to the buffer.
    /// </summary>
