...
/// <summary>
/// Represents an abstract base class for services that require asynchronous initialization and execution.
/// Implements the <see cref="IHostedService"/> interface and provides a mechanism for cleanup through <see cref="IDisposable"/>.
/// </summary>
public abstract class AsyncInitializableService : IHostedService, IDisposable
{
