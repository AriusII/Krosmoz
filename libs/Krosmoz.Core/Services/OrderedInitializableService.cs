...
/// <summary>
/// Represents an abstract base class for services that require ordered initialization and execution.
/// Implements the <see cref="IHostedService"/> interface and provides a mechanism for cleanup through <see cref="IDisposable"/>.
/// </summary>
public abstract class OrderedInitializableService : IHostedService, IDisposable
{
    ...
    public virtual Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _executeTask = Task.Run(Initialize, _cts.Token);
    ...
    /// <summary>
    /// Initializes the service. This method must be implemented by derived classes.
    /// </summary>
