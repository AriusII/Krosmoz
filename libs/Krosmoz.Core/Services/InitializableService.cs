...
/// <summary>
/// Represents an abstract base class for services that require initialization and execution.
/// Implements the <see cref="IHostedService"/> interface and provides a mechanism for cleanup through <see cref="IDisposable"/>.
/// </summary>
public abstract class InitializableService : IHostedService, IDisposable
{
