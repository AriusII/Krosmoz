...
public sealed class InventoryPresetSaveResultMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6170;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static InventoryPresetSaveResultMessage Empty =>
