...
{
	public new const uint StaticProtocolId = 883;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static new ChatServerWithObjectMessage Empty =>
		new() { Fingerprint = string.Empty, Timestamp = 0, Content = string.Empty, Channel = 0, SenderAccountId = 0, SenderName = string.Empty, SenderId = 0, Objects = [] };
