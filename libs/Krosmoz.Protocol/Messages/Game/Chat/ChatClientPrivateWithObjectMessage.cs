...
{
	public new const uint StaticProtocolId = 852;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static new ChatClientPrivateWithObjectMessage Empty =>
		new() { Content = string.Empty, Receiver = string.Empty, Objects = [] };
