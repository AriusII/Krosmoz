...
public sealed class GameRolePlayArenaFightAnswerMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6279;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static GameRolePlayArenaFightAnswerMessage Empty =>
