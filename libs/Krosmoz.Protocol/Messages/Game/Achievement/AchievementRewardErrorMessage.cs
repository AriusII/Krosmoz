...
public sealed class AchievementRewardErrorMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6375;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static AchievementRewardErrorMessage Empty =>
		new() { AchievementId = 0 };
