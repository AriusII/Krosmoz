package org.audiofx.mp3
{
   ...
   internal class MP3Parser extends EventDispatcher implements Poolable
   {
      ...
      public function MP3Parser(param1:MP3FileReferenceLoader)
      {
         super();
      ...
      internal function load(param1:String) : void
      {
      ...
      internal function loadFileRef(param1:FileReference) : void
      {
      ...
      private function getFirstHeaderPosition() : uint
      {
         ...
         while(this.mp3Data.position < this.mp3Data.length)
         {
            ...
            if(_loc2_ == "ID3")
            {
               ...
               _loc4_ = (this.mp3Data.readByte() & 0x7F) << 21;
               _loc5_ = (this.mp3Data.readByte() & 0x7F) << 14;
               _loc6_ = (this.mp3Data.readByte() & 0x7F) << 7;
               _loc7_ = this.mp3Data.readByte() & 0x7F;
      ...
      internal function getNextFrame() : ByteArraySegment
      {
         ...
         {
            _loc1_ = uint(this.mp3Data.readInt());
      ...
      internal function writeSwfFormatByte(param1:ByteArray) : void
      {
      ...
      private function parseHeader(param1:uint) : void
      {
         ...
         var _loc4_:Number = Number(versions[this.version]);
      ...
      private function getFrameSize(param1:uint) : uint
      {
         ...
         var _loc7_:Number = Number(versions[_loc2_]);
         var _loc8_:uint = uint(samplingRates[_loc4_]);
         ...
         return uint((_loc7_ == 1 ? 144 : 72) * _loc10_ / _loc8_ + _loc5_);
      }
      
      private function isValidHeader(param1:uint) : Boolean
      {
         return (this.getFrameSync(param1) & 0x07FF) == 2047 && (this.getVersionIndex(param1) & 3) != 1 && (this.getLayerIndex(param1) & 3) != 0 && (this.getBitrateIndex(param1) & 0x0F) != 0 && (this.getBitrateIndex(param1) & 0x0F) != 15 && (this.getFrequencyIndex(param1) & 3) != 3 && (this.getEmphasisIndex(param1) & 3) != 2;
      }
      
      private function getFrameSync(param1:uint) : uint
      {
         return uint(param1 >> 21 & 0x07FF);
      }
