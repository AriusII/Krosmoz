package by.blooddy.crypto.image
{
   ...
   public class JPEGTableHelper
   {
      ...
      public static function createQuantTable(param1:uint) : ByteArray
      {
         ...
         var _loc2_:uint = uint(param1 <= 1 ? 5000 : (param1 < 50 ? int(5000 / param1) : 200 - (param1 << 1)));
         ...
         do
         {
            _loc6_ = uint(int((li8(130 + _loc5_) * _loc2_ + 50) / 100));
            if(_loc6_ < 1)
            {
               _loc6_ = 1;
            }
         ...
         do
         {
            _loc6_ = uint(int((li8(194 + _loc5_) * _loc2_ + 50) / 100));
            if(_loc6_ < 1)
            {
               _loc6_ = 1;
            }
         ...
         do
         {
            ...
            while(_loc8_ += 8, _loc8_ < 64);
            
         }
         while(_loc7_ += 8, _loc7_ < 64);
      ...
      public static function createHuffmanTable() : ByteArray
      {
         ...
         do
         {
            _loc9_ = uint(li8(_loc7_));
            _loc8_ = 1;
            while(_loc8_ <= _loc9_)
            {
               _loc10_ = uint(416 + li8(17 + _loc6_) * 3);
               si8(_loc7_,_loc10_);
         ...
         do
         {
            _loc9_ = uint(li8(29 + _loc7_));
            _loc8_ = 1;
            while(_loc8_ <= _loc9_)
            {
               _loc10_ = uint(452 + li8(46 + _loc6_) * 3);
               si8(_loc7_,_loc10_);
               si16(_loc5_,_loc10_ + 1);
               _loc6_++;
               _loc5_++;
         ...
         do
         {
            _loc9_ = uint(li8(208 + _loc7_));
            _loc8_ = 1;
            while(_loc8_ <= _loc9_)
            {
               _loc10_ = uint(1205 + li8(225 + _loc6_) * 3);
               si8(_loc7_,_loc10_);
               si16(_loc5_,_loc10_ + 1);
               _loc6_++;
               _loc5_++;
         ...
         do
         {
            _loc9_ = uint(li8(237 + _loc7_));
            _loc8_ = 1;
            while(_loc8_ <= _loc9_)
            {
               _loc10_ = uint(1241 + li8(254 + _loc6_) * 3);
               si8(_loc7_,_loc10_);
               si16(_loc5_,_loc10_ + 1);
               _loc6_++;
               _loc5_++;
