package by.blooddy.crypto
{
   ...
   public class Base64
   {
      ...
      public static function encode(param1:ByteArray, param2:Boolean = false) : String
      {
         ...
         var _loc8_:uint = uint((int(_loc3_ / 3) << 2) + (_loc6_ > 0 ? 4 : 0));
         ...
         while(_loc9_ < _loc7_)
         {
            ...
            si32(li8(_loc11_ >>> 18) | li8(_loc11_ >>> 12 & 0x3F) << 8 | li8(_loc11_ >>> 6 & 0x3F) << 16 | li8(_loc11_ & 0x3F) << 24,_loc10_);
            _loc10_ += 4;
            if(param2 && int((_loc9_ - 64 + 1) % 57) == 0)
            {
         ...
         switch(int(_loc6_))
         {
            case 1:
               _loc11_ = li8(++_loc9_);
               si32(li8(_loc11_ >>> 2) | li8((_loc11_ & 3) << 4) << 8 | 0x3D3D0000,_loc10_);
               break;
            case 2:
               _loc11_ = li8(++_loc9_) << 8 | li8(++_loc9_);
               si32(li8(_loc11_ >>> 10) | li8(_loc11_ >>> 4 & 0x3F) << 8 | li8((_loc11_ & 0x0F) << 2) << 16 | 0x3D000000,_loc10_);
         }
         _loc5_.position = 64 + _loc3_;
      ...
      public static function decode(param1:String) : ByteArray
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc2_:uint = uint(int(param1.length * 0.75));
         ...
         var _loc5_:uint = uint(_loc4_.length - 4 - 1);
