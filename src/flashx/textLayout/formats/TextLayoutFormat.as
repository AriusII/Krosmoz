package flashx.textLayout.formats
{
   ...
   public class TextLayoutFormat implements ITextLayoutFormat
   {
      ...
      public static function isEqual(param1:ITextLayoutFormat, param2:ITextLayoutFormat) : Boolean
      {
         ...
         {
            return Property.equalStyles(_loc3_.tlf_internal::getStyles(),_loc4_.tlf_internal::getStyles(),TextLayoutFormat.tlf_internal::description);
         }
         for each(_loc5_ in TextLayoutFormat.tlf_internal::description)
         {
      ...
      private function setStyleByProperty(param1:Property, param2:*) : void
      {
         ...
         this.tlf_internal::setStyleByName(_loc3_,param2);
      }
      ...
      public function setStyle(param1:String, param2:*) : void
      {
         ...
         {
            this.tlf_internal::setStyleByName(param1,param2);
         }
      }
      ...
      public function copy(param1:ITextLayoutFormat) : void
      {
         ...
         if(param1)
         {
            for each(_loc3_ in TextLayoutFormat.tlf_internal::description)
            {
      ...
      public function concat(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc2_)
         {
            ...
            for(_loc5_ in _loc4_)
            {
               ...
               {
                  this.tlf_internal::setStyleByName(_loc5_,Property.defaultConcatHelper(this._styles[_loc5_],_loc4_[_loc5_]));
               }
            }
            return;
         }
