package flashx.textLayout.elements
{
   ...
   public final class InlineGraphicElement extends FlowLeafElement
   {
      ...
      tlf_internal function getTypographicAscent(param1:TextLine) : Number
      {
         ...
         var _loc4_:ElementFormat = !!_blockElement ? _blockElement.elementFormat : tlf_internal::computeElementFormat();
         ...
         _loc6_ += param1.getBaselinePosition(TextBaseline.ROMAN) - param1.getBaselinePosition(_loc5_);
         return _loc6_ + _loc4_.baselineShift;
      }
      ...
      override tlf_internal function getCSSInlineBox(param1:String, param2:TextLine, param3:ParagraphElement = null, param4:ISWFContext = null) : Rectangle
      {
         ...
         _loc5_.top = -this.tlf_internal::getTypographicAscent(param2);
      ...
      override tlf_internal function calculateUnderlineOffset(param1:Number, param2:String, param3:FontMetrics, param4:TextLine) : Number
      {
         ...
         if(_loc7_)
         {
            ...
            else
            {
               ...
               {
                  _loc6_ = _loc7_.x - this.tlf_internal::elementHeightWithMarginsAndPadding();
                  return _loc6_ - (param3.underlineOffset + param3.underlineThickness / 2);
               }
               _loc6_ = _loc7_.x - tlf_internal::getEffectivePaddingLeft();
            }
         }
         _loc6_ += param3.underlineOffset + param3.underlineThickness / 2;
         var _loc8_:String = _loc5_.tlf_internal::getEffectiveJustificationRule();
