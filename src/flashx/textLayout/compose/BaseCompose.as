   ...
   public class BaseCompose
   {
      ...
      private function advanceToComposeStartPosition() : Boolean
      {
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            _loc10_ = this._curParcel.controller.tlf_internal::numFloats;
            if(_loc10_)
            {
               while(_loc7_ < _loc10_)
               {
                  _loc11_ = this._curParcel.controller.tlf_internal::getFloatAt(_loc7_);
      ...
      tlf_internal function computeTextFlowLineMinimumLogicalTop(param1:TextFlowLine, param2:TextLine) : Number
      {
         ...
         if(param1.tlf_internal::hasGraphicElement)
         {
            ...
            if(_loc7_.tlf_internal::numFloats > 0)
            {
               while(_loc3_ < _loc8_)
               {
                  _loc9_ = _loc7_.tlf_internal::getFloatAtPosition(_loc3_);
                  if(!_loc9_)
                  {
                     break;
                  }
      ...
      protected function composeParagraphElement(param1:ParagraphElement, param2:int) : Boolean
      {
         ...
         {
            _loc5_ = param1.tlf_internal::getTextBlock();
      ...
      protected function composeParagraphElementIntoLines() : Boolean
      {
         ...
         while(_loc1_)
         {
            ...
            _loc8_ = TextFlowLine.tlf_internal::findNumberLine(_loc2_);
            _loc9_ = (_loc8_) && TextFlowLine.tlf_internal::getNumberLineListStylePosition(_loc8_) == ListStylePosition.OUTSIDE || _loc7_ == TextAlign.CENTER || _loc7_ == TextAlign.RIGHT;
      ...
      protected function preProcessILGs(param1:int) : Boolean
      {
         ...
         while(_loc4_)
         {
            if(_loc4_ is InlineGraphicElement)
            {
               ...
               _loc5_.tlf_internal::setEffectiveFloat(this._forceILGs ? Float.NONE : _loc5_.tlf_internal::computedFloat);
               _loc2_ = true;
            }
      ...
      protected function processFloatsAtLineEnd(param1:TextLine) : Boolean
      {
         ...
         if(Boolean(this._pushInFloats) && this._pushInFloats.length > 0)
         {
            ...
            {
               _loc9_ = int(this._pushInFloats.length - 1);
               while(_loc9_ >= 0)
               {
                  ...
                  _loc12_ = this._curLine.controller.tlf_internal::getFloatAtPosition(_loc8_);
                  if((Boolean(_loc12_)) && _loc12_.absolutePosition == _loc8_)
                  {
         ...
         while(_loc2_ < _loc4_)
         {
            if(_loc3_ is InlineGraphicElement)
            {
               ...
               if(_loc14_.tlf_internal::computedFloat == Float.NONE || this._forceILGs)
               {
                  _loc6_ = true;
               }
      ...
      protected function processInlinesAtLineEnd(param1:TextLine) : void
      {
         ...
         while(_loc2_ < _loc4_)
         {
            if(_loc3_ is InlineGraphicElement)
            {
               ...
               if(_loc5_.tlf_internal::computedFloat == Float.NONE || this._forceILGs)
               {
      ...
      {
         var _loc3_:Number = this._blockProgression == BlockProgression.RL ? -param1.tlf_internal::getEffectivePaddingRight() : Number(param1.tlf_internal::getEffectivePaddingLeft());
      ...
      protected function composeFloat(param1:InlineGraphicElement, param2:Boolean) : Boolean
      {
         ...
         if(_loc10_)
         {
            _loc11_ = param1.tlf_internal::computedFloat;
      ...
      private function calculateFloatBounds(param1:InlineGraphicElement, param2:Boolean, param3:String) : Rectangle
      {
         ...
         if(param2)
         {
            _loc4_.x = this._curParcel.right - _floatSlug.depth - param1.tlf_internal::elementWidth - param1.tlf_internal::getEffectivePaddingRight();
            _loc4_.y = param3 == Float.LEFT ? this._curParcel.y + _floatSlug.leftMargin + param1.tlf_internal::getEffectivePaddingTop() : this._curParcel.bottom - _floatSlug.rightMargin - param1.tlf_internal::getEffectivePaddingBottom() - param1.tlf_internal::elementHeight;
            _loc4_.width = param1.tlf_internal::elementWidth;
            _loc4_.height = param1.tlf_internal::elementHeight;
         }
         else
         {
            _loc4_.x = param3 == Float.LEFT ? this._curParcel.x + _floatSlug.leftMargin + param1.tlf_internal::getEffectivePaddingLeft() : this._curParcel.right - _floatSlug.rightMargin - param1.tlf_internal::getEffectivePaddingRight() - param1.tlf_internal::elementWidth;
      ...
      private function getRightSideGap(param1:TextFlowLine, param2:Boolean) : Number
      {
         ...
         if(_loc4_.direction == Direction.RTL && Boolean(param1.location & TextFlowLineLocation.FIRST))
         {
      ...
      private function getLeftSideGap(param1:TextFlowLine) : Number
      {
         ...
         if(_loc3_.direction == Direction.LTR && Boolean(param1.location & TextFlowLineLocation.FIRST))
         {
      ...
      private function calculateLineAlignmentAndBounds(param1:TextLine, param2:TextLine, param3:AlignData) : AlignData
      {
         ...
         if(!param3)
         {
            ...
            if(param2)
            {
               ...
               {
                  _loc15_ = _loc14_ + TextFlowLine.tlf_internal::getNumberLineInsideLineWidth(param2);
         ...
         if(this._blockProgression == BlockProgression.TB)
         {
            for each(_loc5_ in this._alignLines)
            {
               ...
               if(Boolean(_loc3_) && TextFlowLine.tlf_internal::getNumberLineListStylePosition(_loc3_) == ListStylePosition.OUTSIDE)
               {
                  ...
                  _loc12_ += TextFlowLine.tlf_internal::getNumberLineInsideLineWidth(_loc3_);
      ...
      {
         var _loc2_:Number = param1.tlf_internal::measureWidth ? Number.MAX_VALUE : param1.compositionWidth;
         ...
         this._controllerVisibleBoundsWidthTW = param1.tlf_internal::measureWidth ? int.MAX_VALUE : Twips.to(param1.compositionWidth);
         this._controllerVisibleBoundsHeightTW = param1.tlf_internal::measureHeight ? int.MAX_VALUE : Twips.to(param1.compositionHeight);
      }
         ...
         while(Boolean(_loc6_) && _loc7_ < this._curLine.absoluteStart + this._curLine.textLength)
         {
            if(_loc7_ >= this._curLine.absoluteStart || _loc7_ + _loc6_.textLength >= this._curLine.absoluteStart)
            {
               if(_loc6_ is InlineGraphicElement)
               {
                  ...
                  if(_loc10_.tlf_internal::effectiveFloat == Float.NONE && !(this._blockProgression == BlockProgression.RL && _loc6_.parent is TCYElement))
                  {
                     if(_loc9_ < _loc10_.tlf_internal::getEffectiveFontSize())
                     {
                        _loc9_ = _loc10_.tlf_internal::getEffectiveFontSize();
                        if(_loc9_ >= _loc8_)
                        {
                           _loc9_ = _loc9_;
...
class AlignData
{
   ...
   public function AlignData(param1:TextFlowLine)
   {
      super();
