package gs
{
   ...
   public class TweenMax extends TweenFilterLite implements IEventDispatcher
   {
      ...
      public static function multiSequence(param1:Array) : Array
      {
         ...
         var _loc3_:Array = [];
         var _loc4_:int = int(TweenLite.overwriteManager.mode);
         var _loc5_:Number = 0;
         _loc10_ = 0;
         while(_loc10_ < param1.length)
         {
            _loc6_ = param1[_loc10_];
            _loc9_ = Number(Number(_loc6_.time) || 0);
            _loc11_ = {};
            ...
            delete _loc11_.time;
            _loc8_ = Number(Number(_loc11_.delay) || 0);
      ...
      public static function isTweening(param1:Object) : Boolean
      {
         ...
         while(_loc3_ > -1)
         {
            if(Boolean(_loc2_[_loc3_].active) && !_loc2_[_loc3_].gc)
            {
               return true;
            }
            _loc3_--;
      ...
      public static function changePause(param1:Boolean, param2:Boolean = true, param3:Boolean = false) : void
      {
         var _loc5_:* = false;
         var _loc4_:Array = getAllTweens();
         var _loc6_:int = int(_loc4_.length - 1);
         while(_loc6_ > -1)
         {
            _loc5_ = _loc4_[_loc6_].target == _loc4_[_loc6_].vars.onComplete;
      ...
      public static function bezierProxy(param1:Object, param2:Number = 0) : void
      {
         ...
         var _loc9_:Number = NaN;
         var _loc10_:uint = 0;
         var _loc3_:Number = Number(param1.target.t);
         ...
         else
         {
            for(_loc7_ in _loc4_)
            {
               _loc10_ = uint(_loc4_[_loc7_].length);
               if(_loc3_ < 0)
               {
                  _loc6_ = 0;
               }
      ...
      public static function bezierProxy2(param1:Object, param2:Number = 0) : void
      {
         ...
         while(_loc11_ < _loc5_.length)
         {
            ...
            _loc10_ = Number(Number(_loc9_[3]) || 0);
      ...
      override public function initTweenVals(param1:Boolean = false, param2:String = "") : void
      {
         ...
         var _loc9_:Number = NaN;
         param2 += " hexColors bezier bezierThrough shortRotation orientToBezier quaternions onCompleteAll onCompleteAllParams yoyo loop onCompleteListener onUpdateListener onStartListener ";
         if(!param1 && Boolean(TweenLite.overwriteManager.enabled))
         {
         ...
         if(this.vars.bezier != undefined && this.vars.bezier is Array)
         {
            ...
            addSubTween("bezier",_loc8_,{"t":0},{"t":1},{
         ...
         if(this.vars.bezierThrough != undefined && this.vars.bezierThrough is Array)
         {
            ...
            addSubTween("bezierThrough",_loc8_,{"t":0},{"t":1},{
         ...
         {
            _loc9_ = (this.vars.shortRotation - this.target.rotation) % 360;
            if(_loc9_ != _loc9_ % 180)
            {
               _loc9_ = _loc9_ < 0 ? _loc9_ + 360 : _loc9_ - 360;
            }
            this.tweens[this.tweens.length] = [this.target,"rotation",this.target.rotation,_loc9_,"rotation"];
         }
         if(this.vars.hexColors != undefined && typeof this.vars.hexColors == "object")
         {
            for(_loc3_ in this.vars.hexColors)
            {
               addSubTween("hexColors",hexColorsProxy,{
                  ...
                  "g":this.target[_loc3_] >> 8 & 0xFF,
                  "b":this.target[_loc3_] & 0xFF
               },{
                  "r":this.vars.hexColors[_loc3_] >> 16,
                  "g":this.vars.hexColors[_loc3_] >> 8 & 0xFF,
                  "b":this.vars.hexColors[_loc3_] & 0xFF
               },{
                  "prop":_loc3_,
                  "target":this.target
               });
