      ...
      private function RGB2YUV(param1:BitmapData, param2:ByteArray, param3:int, param4:int, param5:int, param6:int) : void
      {
         ...
         while(_loc8_ < 8)
         {
            ...
            while(_loc10_ < 8)
            {
               ...
               if(param1)
               {
                  _loc12_ = param1.getPixel32(_loc11_,_loc9_);
               }
               else
               {
                  param2.position = 4 * (_loc9_ * param5 + _loc11_);
                  _loc12_ = param2.readUnsignedInt();
               }
               _loc13_ = Number(_loc12_ >> 16 & 0xFF);
               _loc14_ = Number(_loc12_ >> 8 & 0xFF);
               _loc15_ = Number(_loc12_ & 0xFF);
               this.YDU[_loc7_] = 0.299 * _loc13_ + 0.587 * _loc14_ + 0.114 * _loc15_ - 128;
               this.UDU[_loc7_] = -0.16874 * _loc13_ - 0.33126 * _loc14_ + 0.5 * _loc15_;
               this.VDU[_loc7_] = 0.5 * _loc13_ - 0.41869 * _loc14_ - 0.08131 * _loc15_;
               _loc7_++;
               _loc10_++;
            }
            _loc8_++;
