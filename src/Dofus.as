package
{
   ...
   public class Dofus extends Sprite implements IFramerateListener, IApplicationContainer
   {
      ...
      public function clearCache(param1:Boolean = false, param2:Boolean = false) : void
      {
         ...
         soFolder = new File(CustomSharedObject.getCustomSharedObjectDirectory());
         if(Boolean(soFolder) && Boolean(soFolder.exists))
         {
      ...
      private function initUi() : void
      {
         ...
         UiModuleManager.getInstance().sharedDefinitionContainer = _loc2_;
