package com.ankamagames.atouin
{
   ...
   public class Atouin
   {
      ...
      public function setDisplayOptions(param1:AtouinOptions) : void
      {
         ...
         var _loc3_:int = int(StageShareManager.startWidth);
         var _loc4_:int = int(StageShareManager.startHeight);
      ...
      {
         InteractiveCellManager.getInstance().show(param1 || Boolean(this.options.alwaysShowGrid),param2);
      }
      ...
      {
         var _loc2_:int = int(Atouin.getInstance()._movementListeners.indexOf(param1));
         if(_loc2_)
         {
      ...
      public function zoom(param1:Number, param2:int = 0, param3:int = 0) : void
      {
         ...
         else
         {
            ...
            _loc4_ = this._currentZoom;
            this._currentZoom = param1;
            if(_loc4_ == this._currentZoom)
            {
               return;
            }
            ...
            _loc5_ = param2 * this._currentZoom;
            _loc6_ = param3 * this._currentZoom;
            this._worldContainer.x = 608 - _loc5_;
            this._worldContainer.y = 470 - _loc6_;
