package com.ankamagames.atouin.managers
{
   ...
   public class MapDisplayManager
   {
      ...
      private var _mapFileCache:ICache = new Cache(20,new LruGarbageCollector());
      ...
      public function capture() : void
      {
         ...
         if(Boolean(Atouin.getInstance().options.tweentInterMap) || Boolean(Atouin.getInstance().options.hideInterMap))
         {
      ...
      {
         if(this._renderer && this._renderer.identifiedElements && Boolean(this._renderer.identifiedElements[param1]))
         {
      ...
      private function checkForRender() : void
      {
         ...
         if(!_loc3_ && this._currentMap && this._currentMap.mapId == _loc2_.mapId && !Atouin.getInstance().options.reloadLoadedMap)
         {
            ...
            if(_loc5_.zoomScale != 1 && Boolean(_loc7_.options.useInsideAutoZoom))
            {
      ...
      private function onMapFailed(param1:ResourceErrorEvent) : void
      {
         ...
         _loc2_.errorReason = MapLoadingFailedMessage.NO_FILE;
      ...
      private function mapRendered(param1:RenderMapEvent) : void
      {
         ...
         if(param1.type == RenderMapEvent.MAP_RENDER_END)
         {
            ...
            _loc2_ = uint(this._nRenderMapEnd - this._nMapLoadStart);
...
class RenderRequest
{
   ...
   public function RenderRequest(param1:WorldPoint, param2:Boolean, param3:ByteArray)
   {
      super();
