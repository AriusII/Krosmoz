package com.ankamagames.atouin.managers
{
   ...
   public class EntitiesDisplayManager
   {
      ...
      public function displayEntity(param1:IDisplayable, param2:MapPoint, param3:uint = 0) : void
      {
         ...
         {
            strata = uint(this._dStrataRef[oEntity]);
         }
         else
         {
      ...
      public function orderEntity(param1:DisplayObject, param2:Sprite) : void
      {
         ...
         if((Boolean(_loc4_)) && Boolean(_loc4_.parentSprite))
         {
            _loc3_ = true;
         }
         ...
         var _loc5_:uint = uint(param2.parent.getChildIndex(param2));
         var _loc6_:int = param2.parent.numChildren;
         var _loc8_:Boolean = true;
         _loc9_ = uint(_loc5_ + 1);
         while(_loc9_ < _loc6_)
         {
