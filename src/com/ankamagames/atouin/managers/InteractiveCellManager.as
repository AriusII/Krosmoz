package com.ankamagames.atouin.managers
{
   ...
   public class InteractiveCellManager
   {
      ...
      private var _bShowGrid:Boolean = Atouin.getInstance().options.alwaysShowGrid;
      ...
      public function updateInteractiveCell(param1:DataMapContainer) : void
      {
         ...
         var _loc6_:Boolean = Boolean(Atouin.getInstance().options.showTransitions);
         var _loc7_:Number = this._bShowGrid || Boolean(Atouin.getInstance().options.alwaysShowGrid) ? 1 : 0;
      ...
      public function show(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         var _loc3_:Number = this._bShowGrid || Boolean(Atouin.getInstance().options.alwaysShowGrid) ? 1 : 0;
         ...
         while(_loc6_ < this._aCells.length)
         {
            ...
            if(_loc5_)
            {
               if((param2 || this._cellOverEnabled) && _loc3_ == 1 && Boolean(_loc4_[_loc6_].nonWalkableDuringFight))
               {
                  _loc5_.alpha = 0;
               }
               else
