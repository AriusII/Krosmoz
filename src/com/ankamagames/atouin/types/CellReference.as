package com.ankamagames.atouin.types
{
   ...
   public class CellReference
   {
      ...
      public function getAvgColor() : uint
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         var _loc6_:int = int(this.listSprites.length);
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc4_ = (this.listSprites[_loc5_] as DisplayObject).transform.colorTransform;
            _loc1_ += _loc4_.redOffset * _loc4_.redMultiplier;
            _loc2_ += _loc4_.greenOffset * _loc4_.greenMultiplier;
            _loc3_ += _loc4_.blueOffset * _loc4_.blueMultiplier;
            _loc5_ += 1;
         }
         _loc1_ /= _loc6_;
         _loc2_ /= _loc6_;
