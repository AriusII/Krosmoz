package com.ankamagames.atouin.types
{
   ...
   public class DataMapContainer
   {
      ...
      public function clean(param1:Boolean = false) : Boolean
      {
         ...
         _loc8_.x -= MapDisplayManager.getInstance().currentMapPoint.x;
         _loc8_.y -= MapDisplayManager.getInstance().currentMapPoint.y;
      ...
      {
         if(Boolean(param1.parent) && param1.parent == this._spMap)
         {
