package com.ankamagames.dofus.console
{
   ...
   public class DebugConsoleInstructionRegistar implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(param1:ConsoleHandler) : void
      {
         ...
         param1.addHandler(["savereplaylog","parallelsequenceteststart","log","i18nsize","newdofus","clear","config","clearwebcache","geteventmodeparams","setquality","lowdefskin","copylog","synchrosequence","throw","debugmouseover","idletime"],new MiscInstructionHandler());
