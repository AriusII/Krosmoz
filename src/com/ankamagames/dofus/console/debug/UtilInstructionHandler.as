   ...
   public class UtilInstructionHandler implements ConsoleInstructionHandler
   {
      ...
      private function info(param1:ConsoleHandler, param2:String, param3:Array) : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc11_ = Boolean(_loc7_.hasOwnProperty("name"));
            ...
            for each(_loc12_ in _loc9_)
            {
               ...
               {
                  _loc10_ += "\t" + _loc12_ + " : " + _loc13_.toString() + "\n";
               }
               else
               {
                  ...
                  if(_loc14_ > 30)
                  {
                     ...
                     _loc10_ += "\t" + _loc12_ + "(" + _loc14_ + " element(s)) : " + _loc13_.toString() + ", ...\n";
                  }
                  else
                  {
                     _loc10_ += "\t" + _loc12_ + "(" + _loc14_ + " element(s)) : " + _loc13_.toString() + "\n";
            ...
            if(_loc7_.indexOf(_loc5_) != -1)
            {
               ...
               if(_loc13_[0][_loc5_] is Number)
               {
                  ...
                  for each(_loc9_ in _loc13_)
                  {
                     if(_loc9_)
                     {
                        _loc10_ = Boolean(_loc9_.hasOwnProperty("name"));
