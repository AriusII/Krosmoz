      ...
      public function handle(param1:ConsoleHandler, param2:String, param3:Array) : void
      {
         ...
         switch(param2)
         {
            ...
            case "addsoundinplaylist":
               ...
               _loc4_ = param3[0];
               _loc11_ = uint(param3[1]);
               _loc12_ = uint(param3[2]);
               _loc13_ = uint(param3[3]);
      ...
      public function getParamPossibilities(param1:String, param2:uint = 0, param3:Array = null) : Array
      {
         ...
         switch(param1)
         {
            case "adduisoundelement":
               if(param2 == 0)
               {
                  return this.getUiList(Boolean(param3) && Boolean(param3.length) ? param3[0] : null);
               }
               if(param2 == 2)
               {
                  _loc4_ = Boolean(param3) && param3.length > 2 ? param3[2].toLowerCase() : "";
                  _loc5_ = [];
