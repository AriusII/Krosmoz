package com.ankamagames.dofus.console.debug
{
   ...
   public class DtdInstructionHandler implements ConsoleInstructionHandler
   {
         ...
         switch(param2)
         {
            case "kerneleventdtd":
               ...
               for each(_loc4_ in _loc8_..constant)
               {
                  ...
                  _loc5_ += "&lt;!ELEMENT " + _loc6_ + " EMPTY &gt;\n";
                  _loc7_.push(_loc6_);
               }
               _loc5_ += "&lt;!ELEMENT SystemEvents (" + _loc7_.join(" | ") + ")* &gt;";
            ...
            case "dtd":
               ...
               for(_loc18_ in _loc14_)
               {
                  ...
                  {
                     _loc16_ += "&lt;!ELEMENT " + _loc18_ + " (#PCDATA) &gt;&lt;!-- " + _loc14_[_loc18_].type + ", used by " + _loc14_[_loc18_].ref.join(", ") + " --&gt;\n";
                  }
               }
               if(_loc16_.length)
               {
               ...
               for(_loc18_ in _loc13_)
               {
                  ...
                  for(_loc19_ in _loc13_[_loc18_])
                  {
                     ...
                     {
                        _loc5_ += "&lt;!ELEMENT " + _loc19_ + " (#PCDATA) &gt;&lt;!-- " + _loc13_[_loc18_][_loc19_] + " --&gt;\n";
                     }
                  }
                  _loc7_.push("Size?");
                  _loc7_.push("Anchors?");
                  _loc7_.push("Events?");
                  _loc5_ += "&lt;!ELEMENT " + _loc18_ + " (" + _loc7_.join(" | ") + ")* &gt;\n";
      ...
      private function parseShortcutXml(param1:String) : void
      {
         ...
         {
            _loc3_ += "&lt;!ELEMENT " + _loc5_..@name + " EMPTY &gt;\n";
            _loc4_.push(_loc5_..@name);
         }
         _loc3_ += "&lt;!ELEMENT Shortcuts (" + _loc4_.join(" | ") + ")* &gt;";
