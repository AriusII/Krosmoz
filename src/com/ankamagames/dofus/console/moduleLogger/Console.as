package com.ankamagames.dofus.console.moduleLogger
{
   ...
   public final class Console
   {
      ...
      private var _allInfo:Vector.<TypeMessage> = new Vector.<TypeMessage>();
      ...
      private function log(... rest) : void
      {
         ...
         if(this._active && Boolean(rest.length))
         {
      ...
      private function createUI() : void
      {
         ...
         _loc2_ += ICON_SIZE + ICON_INTERVAL;
      ...
      private function loadData(param1:Object) : void
      {
         if(param1)
         {
            ...
            if(Boolean(param1.hasOwnProperty("showHook")) && !param1.showHook)
            {
               this._filterButton[0].disable(true);
               this._showHook = false;
            }
            if(Boolean(param1.hasOwnProperty("showUI")) && !param1.showUI)
            {
               this._filterButton[1].disable(true);
               this._showUI = false;
            }
            if(Boolean(param1.hasOwnProperty("showAction")) && !param1.showAction)
            {
               this._filterButton[2].disable(true);
               this._showAction = false;
            }
            if(Boolean(param1.hasOwnProperty("showShortcut")) && !param1.showShortcut)
            {
      ...
      private function onFilterChange(param1:Event = null) : void
      {
         ...
         this._lines.splice(0,this._lines.length);
         var _loc2_:Boolean = Boolean(this._filterUI) && this._filterUI.isOn;
         var _loc3_:int = int(this._allInfo.length);
         var _loc4_:int = -1;
         while(++_loc4_ < _loc3_)
         {
      ...
      private function onResize(param1:Event = null) : void
      {
         ...
         if(this._filterButton)
         {
            ...
            _loc6_ = int(this._filterButton.length - 1);
            while(_loc6_ >= 0)
            {
