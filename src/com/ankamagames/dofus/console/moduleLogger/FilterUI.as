package com.ankamagames.dofus.console.moduleLogger
{
   ...
   public final class FilterUI extends Sprite
   {
      ...
      private var _excludeList:Array = new Array();
      
      private var _includeText:String = "";
      
      private var _includeList:Array = new Array();
      ...
      public function isFiltered(param1:String) : Boolean
      {
         ...
         {
            _loc2_ = int(this._includeList.length);
            _loc3_ = -1;
            while(++_loc3_ < _loc2_)
            {
      ...
      public function resize() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(this._filterList) && Boolean(this._title))
         {
