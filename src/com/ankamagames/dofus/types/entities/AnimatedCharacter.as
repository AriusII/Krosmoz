package com.ankamagames.dofus.types.entities
{
   ...
   public class AnimatedCharacter extends TiphonSprite implements IEntity, IMovable, IDisplayable, IAnimated, IInteractive, IRectangle, IObstacle, ITransparency, ICustomUnicNameGetter
   {
      ...
      private function onFirstError(param1:TiphonEvent) : void
      {
         ...
         var _loc3_:uint = uint(DirectionsEnum.DOWN_RIGHT);
      ...
      public function move(param1:MovementPath, param2:Function = null) : void
      {
         ...
         var _loc3_:uint = uint(param1.path.length + 1);
         ...
         else
         {
            if(Kernel.getWorker().contains(RoleplayEntitiesFrame))
            {
               ...
               else if(_loc7_ is GameRolePlayGroupMonsterInformations)
               {
                  this._movementBehavior = WalkingMovementBehavior.getInstance();
               }
            }
         ...
         var _loc4_:int = int(this.getDirection());
         ...
         if(this._followers.length > 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc13_ = int(Atouin.getInstance().getIdentifiedElementPosition(_loc12_.elementId).cellId);
                  _loc9_.push(_loc13_);
               }
            }
         }
         for each(_loc6_ in this._followers)
         {
            ...
            if(_loc14_)
            {
               ...
               if(Boolean(_loc16_[1]) && !_loc16_[3])
               {
                  _loc17_++;
               }
               if(!_loc16_[1] && Boolean(_loc16_[3]))
               {
                  _loc17_++;
               }
               if(Boolean(_loc16_[7]) && !_loc16_[5])
               {
                  _loc17_++;
               }
               if(!_loc16_[7] && Boolean(_loc16_[5]))
               {
                  _loc17_++;
               }
               if(!_loc16_[0] && Boolean(_loc16_[4]))
               {
                  _loc17_++;
               }
               if(Boolean(_loc16_[0]) && !_loc16_[4])
               {
                  _loc17_++;
               }
      ...
      private function processMove(param1:MovementPath, param2:Array) : void
      {
         ...
         if(Boolean(param1) && param1.path.length > 0)
         {
      ...
      public function removeAllFollowers() : void
      {
         ...
         var _loc1_:int = int(this._followers.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function addFollower(param1:IMovable, param2:Boolean = false) : void
      {
         ...
         if(param1 is IDisplayable)
         {
            ...
            else if(!this._displayed && _loc5_.displayed)
            {
               _loc5_.remove();
            }
         }
      ...
      public function highLightCharacterAndFollower(param1:Boolean) : void
      {
         ...
         var _loc3_:int = int(_loc2_._followers.length);
         var _loc4_:int = -1;
         while(++_loc4_ < _loc3_)
         {
