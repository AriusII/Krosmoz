package com.ankamagames.dofus.kernel.sound
{
   ...
   public class SoundManager
   {
      ...
      public function setSoundOptions() : void
      {
         ...
         try
         {
            musicMute = Boolean(OptionManager.getOptionManager("tubul")["muteMusic"]);
            soundMute = Boolean(OptionManager.getOptionManager("tubul")["muteSound"]);
            ambientSoundMute = Boolean(OptionManager.getOptionManager("tubul")["muteAmbientSound"]);
            infiniteLoop = Boolean(OptionManager.getOptionManager("tubul")["infiniteLoopMusics"]);
            ...
            soundActivated = Boolean(OptionManager.getOptionManager("tubul")["tubulIsDesactivated"]);
            if(soundActivated)
            {
      ...
      private function onPropertyChanged(param1:PropertyChangeEvent) : void
      {
         ...
         {
            case "muteMusic":
               this.setMusicVolume(!!param1.propertyValue ? 0 : Number(this._tuOptions.volumeMusic));
               break;
            case "muteSound":
               this.setSoundVolume(!!param1.propertyValue ? 0 : Number(this._tuOptions.volumeSound));
               break;
            case "muteAmbientSound":
               this.setAmbienceVolume(!!param1.propertyValue ? 0 : Number(this._tuOptions.volumeAmbientSound));
               break;
            case "volumeMusic":
