   ...
   public class Kernel
   {
      ...
      public function postInit() : void
      {
         ...
         if(XmlConfig.getInstance().getEntry("config.buildType"))
         {
            ...
            {
               case "debug":
                  _loc4_ = int(BuildTypeEnum.DEBUG);
                  break;
               case "internal":
                  _loc4_ = int(BuildTypeEnum.INTERNAL);
                  break;
               case "testing":
                  _loc4_ = int(BuildTypeEnum.TESTING);
                  break;
               case "alpha":
                  _loc4_ = int(BuildTypeEnum.ALPHA);
                  break;
               case "beta":
                  _loc4_ = int(BuildTypeEnum.BETA);
                  break;
               case "release":
                  _loc4_ = int(BuildTypeEnum.RELEASE);
            }
