package com.ankamagames.dofus.uiApi
{
   ...
   public class DataApi implements IApi
   {
      ...
      public function getSetEffects(param1:Array, param2:Array = null) : Array
      {
         ...
         if(Boolean(param2) && Boolean(param2.length))
         {
            for each(_loc15_ in param2)
            {
               ...
               else if(Boolean(Effect.getEffectById(_loc15_.effectId)) && Effect.getEffectById(_loc15_.effectId).useDice)
               {
      ...
      public function getLivingObjectSkins(param1:ItemWrapper) : Array
      {
         ...
         {
            _loc2_.push(LivingObjectSkinWrapper.create(!!param1.livingObjectId ? int(param1.livingObjectId) : param1.id,param1.livingObjectMood,_loc3_));
            _loc3_++;
         }
         return _loc2_;
      }
