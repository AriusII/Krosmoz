package com.ankamagames.dofus.uiApi
{
   ...
   public class FileApi implements IApi
   {
      ...
      private var _openedFiles:Dictionary = new Dictionary();
      ...
      public function deleteFile(param1:String) : void
      {
         ...
         if(Boolean(_loc2_.exists) && !_loc2_.isDirectory)
         {
            _loc2_.deleteFile();
         }
      }
      ...
      public function getDirectoryContent(param1:String = null, param2:Boolean = false, param3:Boolean = false) : Array
      {
         ...
         if(Boolean(_loc5_.exists) && Boolean(_loc5_.isDirectory))
         {
            ...
            for each(_loc7_ in _loc6_)
            {
               ...
               if(Boolean(_loc7_.isDirectory) && !param3)
               {
      ...
      public function isDirectory(param1:String) : Boolean
      {
         ...
         return Boolean(_loc2_.exists) && Boolean(_loc2_.isDirectory);
      }
