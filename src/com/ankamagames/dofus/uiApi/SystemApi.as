   ...
   public class SystemApi implements IApi
   {
      ...
      public function sendAction(param1:Object) : uint
      {
         ...
         if(param1.hasOwnProperty("parameters"))
         {
            ...
            if(!this._module.trusted && Boolean(_loc2_.maxUsePerFrame))
            {
            ...
            if(!this._module.trusted && Boolean(_loc2_.minimalUseInterval))
            {
               _loc5_ = getTimer() - _actionTsRef[_loc2_];
               if(Boolean(_actionTsRef[_loc2_]) && _loc5_ <= _loc2_.minimalUseInterval)
               {
                  return 0;
               }
      ...
      private function onActionConfirm(param1:Action, param2:DofusApiAction) : Function
      {
         ...
         return function(... rest):void
         {
            ...
            if(Boolean(rest.length) && Boolean(rest[0]))
            {
      ...
      public function setAirVersion(param1:uint) : Boolean
      {
         ...
         file_air1 = new File(File.applicationDirectory.nativePath + File.separator + "useOldAir");
         file_air2 = new File(File.applicationDirectory.nativePath + File.separator + "useNewAir");
         if(version == 1)
         {
            try
            {
      ...
      public function goToCheckLink(param1:String, param2:uint, param3:String) : void
      {
         ...
         this._log.debug("goToCheckLink : " + param1 + " " + _loc5_ + " " + _loc7_ + " " + 1 + " " + _loc10_);
         var _loc11_:String = param1 + _loc5_ + "" + _loc7_ + "" + _loc6_ + param3 + (1).toString() + _loc10_.toString();
         var _loc12_:String = AdvancedMd5.hex_hmac_md5(">:fIZ?vfU0sDM_9j",_loc11_);
         var _loc13_:* = "{\"url\":\"" + param1 + "\",\"click_account\":" + _loc5_ + ",\"from_account\":" + _loc7_ + ",\"click_name\":\"" + _loc6_ + "\",\"from_name\":\"" + _loc8_ + "\",\"game\":" + 1 + ",\"server\":" + _loc10_ + ",\"hmac\":\"" + _loc12_ + "\"}";
         ...
         {
            _loc15_ += _loc14_.readUnsignedByte().toString(16);
         }
      ...
      {
         return Boolean(UpdaterConnexionHandler.getConnection()) && UpdaterConnexionHandler.getConnection().connected;
      }
