package com.ankamagames.dofus.uiApi
{
   ...
   public class ConnectionApi implements IApi
   {
      ...
      {
         QueueFrame.getInstance().allowAutoConnectCharacter = param1;
      }
      ...
      public function getAutochosenServer() : GameServerInformations
      {
         ...
         var _loc3_:int = int(PlayerManager.getInstance().communityId);
         ...
         if(_loc2_.length == 0)
         {
            for each(_loc6_ in this.serverSelectionFrame.servers)
            {
               ...
               if((Boolean(_loc7_)) && _loc7_.communityId == 2)
               {
                  _loc2_.push(_loc6_);
               }
            }
