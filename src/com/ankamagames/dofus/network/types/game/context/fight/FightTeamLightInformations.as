package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightTeamLightInformations extends AbstractFightTeamInformations implements INetworkType
   {
      ...
      public function initFightTeamLightInformations(param1:uint = 2, param2:int = 0, param3:int = 0, param4:uint = 0, param5:uint = 0, param6:uint = 0, param7:Boolean = false, param8:Boolean = false, param9:Boolean = false, param10:Boolean = false) : FightTeamLightInformations
      {
         ...
         this.hasGroupMember = param9;
         this.hasMyTaxCollector = param10;
         return this;
      }
      ...
      public function serializeAs_FightTeamLightInformations(param1:IDataOutput) : void
      {
         ...
         _loc2_ = BooleanByteWrapper.setFlag(_loc2_,2,this.hasGroupMember);
         _loc2_ = BooleanByteWrapper.setFlag(_loc2_,3,this.hasMyTaxCollector);
      ...
      public function deserializeAs_FightTeamLightInformations(param1:IDataInput) : void
      {
         ...
         this.hasGroupMember = BooleanByteWrapper.getFlag(_loc2_,2);
         this.hasMyTaxCollector = BooleanByteWrapper.getFlag(_loc2_,3);
