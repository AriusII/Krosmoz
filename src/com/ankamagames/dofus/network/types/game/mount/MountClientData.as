package com.ankamagames.dofus.network.types.game.mount
{
   ...
   public class MountClientData implements INetworkType
   {
      ...
      public var ancestor:Vector.<uint> = new Vector.<uint>();
      
      public var behaviors:Vector.<uint> = new Vector.<uint>();
      ...
      public var effectList:Vector.<ObjectEffectInteger> = new Vector.<ObjectEffectInteger>();
      ...
      public function deserializeAs_MountClientData(param1:IDataInput) : void
      {
         ...
         var _loc7_:uint = uint(param1.readUnsignedShort());
         var _loc8_:uint = 0;
         while(_loc8_ < _loc7_)
         {
