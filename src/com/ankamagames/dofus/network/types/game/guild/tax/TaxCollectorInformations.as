package com.ankamagames.dofus.network.types.game.guild.tax
{
   ...
   public class TaxCollectorInformations implements INetworkType
   {
      ...
      public function initTaxCollectorInformations(param1:int = 0, param2:uint = 0, param3:uint = 0, param4:AdditionalTaxCollectorInformations = null, param5:int = 0, param6:int = 0, param7:uint = 0, param8:int = 0, param9:EntityLook = null, param10:Vector.<TaxCollectorComplementaryInformations> = null) : TaxCollectorInformations
      {
