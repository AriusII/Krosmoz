package com.ankamagames.dofus.network.messages.game.inventory.items
{
   ...
   public class SetUpdateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public var setObjects:Vector.<uint> = new Vector.<uint>();
      
      public var setEffects:Vector.<ObjectEffect> = new Vector.<ObjectEffect>();
      ...
      public function deserializeAs_SetUpdateMessage(param1:IDataInput) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc7_ = uint(param1.readUnsignedShort());
