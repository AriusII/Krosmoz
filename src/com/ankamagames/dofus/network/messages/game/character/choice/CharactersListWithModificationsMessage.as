package com.ankamagames.dofus.network.messages.game.character.choice
{
   ...
   public class CharactersListWithModificationsMessage extends CharactersListMessage implements INetworkMessage
   {
      ...
      public var charactersToRecolor:Vector.<CharacterToRecolorInformation> = new Vector.<CharacterToRecolorInformation>();
      
      public var charactersToRename:Vector.<int> = new Vector.<int>();
      
      public var unusableCharacters:Vector.<int> = new Vector.<int>();
      
      public var charactersToRelook:Vector.<CharacterToRelookInformation> = new Vector.<CharacterToRelookInformation>();
