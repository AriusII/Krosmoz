package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapComplementaryInformationsDataMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAs_MapComplementaryInformationsDataMessage(param1:IDataInput) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc14_ = uint(param1.readUnsignedShort());
         ...
         while(_loc5_ < _loc4_)
         {
            _loc16_ = uint(param1.readUnsignedShort());
         ...
         while(_loc7_ < _loc6_)
         {
            _loc18_ = uint(param1.readUnsignedShort());
         ...
         var _loc12_:uint = uint(param1.readUnsignedShort());
         var _loc13_:uint = 0;
