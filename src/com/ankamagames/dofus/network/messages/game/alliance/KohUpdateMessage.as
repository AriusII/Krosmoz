package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class KohUpdateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public var allianceMapWinner:BasicAllianceInformations = new BasicAllianceInformations();
      ...
      public function initKohUpdateMessage(param1:Vector.<AllianceInformations> = null, param2:Vector.<uint> = null, param3:Vector.<uint> = null, param4:Vector.<uint> = null, param5:BasicAllianceInformations = null, param6:uint = 0, param7:uint = 0) : KohUpdateMessage
      {
      ...
      public function deserializeAs_KohUpdateMessage(param1:IDataInput) : void
      {
         ...
         var _loc8_:uint = uint(param1.readUnsignedShort());
         var _loc9_:uint = 0;
         while(_loc9_ < _loc8_)
         {
            _loc13_ = uint(param1.readByte());
            if(_loc13_ < 0)
            {
