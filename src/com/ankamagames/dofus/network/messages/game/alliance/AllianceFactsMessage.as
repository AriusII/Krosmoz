package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceFactsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public var infos:AllianceFactSheetInformations = new AllianceFactSheetInformations();
      
      public var guilds:Vector.<GuildInAllianceInformations> = new Vector.<GuildInAllianceInformations>();
      
      public var controlledSubareaIds:Vector.<uint> = new Vector.<uint>();
