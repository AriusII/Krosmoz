package com.ankamagames.dofus.network.messages.game.interactive.zaap
{
   ...
   public class TeleportDestinationsListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public var mapIds:Vector.<uint> = new Vector.<uint>();
      
      public var subAreaIds:Vector.<uint> = new Vector.<uint>();
      
      public var costs:Vector.<uint> = new Vector.<uint>();
      
      public var destTeleporterType:Vector.<uint> = new Vector.<uint>();
