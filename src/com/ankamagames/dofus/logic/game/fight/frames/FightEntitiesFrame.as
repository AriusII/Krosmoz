package com.ankamagames.dofus.logic.game.fight.frames
{
   ...
   public class FightEntitiesFrame extends AbstractEntitiesFrame implements Frame
   {
      ...
      private var _tempFighterList:Array = new Array();
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is GameEntitiesDispositionMessage:
               ...
               {
                  if(Boolean(getEntityInfos(_loc26_.id)) && GameFightFighterInformations(getEntityInfos(_loc26_.id)).stats.invisibilityState != GameActionFightInvisibilityStateEnum.INVISIBLE)
                  {
            ...
            case param1 is MapComplementaryInformationsDataMessage:
               ...
               for each(_loc31_ in _loc19_.interactiveElements)
               {
                  ...
                  else if(_loc31_.disabledSkills.length)
                  {
            ...
            if(_loc11_)
            {
               ...
               if(_loc12_)
               {
                  if(_loc11_.teamId == 0)
                  {
                     ...
                     _loc5_ += _loc12_.initiative * _loc12_.lifePoints / _loc12_.maxLifePoints;
                  }
                  else
                  {
                     _loc3_.push({
                     ...
                     _loc6_ += _loc12_.initiative * _loc12_.lifePoints / _loc12_.maxLifePoints;
                  }
               }
            }
         }
               ...
               for each(_loc7_ in _loc6_)
               {
                  if(_loc7_.id == param3[_loc5_].id)
                  {
                     ...
                     if(_loc9_ && param1.stats.hasOwnProperty(_loc9_) && _loc10_.active)
                     {
                        ...
                        {
                           param1.stats["maxActionPoints"] -= param3[_loc5_].delta;
                        }
                        param1.stats[_loc9_] -= param3[_loc5_].delta;
                     }
                  }
               }
               _loc5_++;
      ...
      private function updateCarriedEntities(param1:GameContextActorInformations) : void
      {
         ...
         var _loc3_:int = int(this._tempFighterList.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      public function updateAllEntitiesNumber(param1:Vector.<int>) : void
      {
         ...
         {
            if(Boolean(_entities[_loc3_]) && Boolean(_entities[_loc3_].alive))
            {
      ...
      public function updateEntityNumber(param1:int, param2:uint) : void
      {
         ...
         var _loc5_:AnimatedCharacter = null;
         if(Boolean(_entities[param1]) && (!(_entities[param1] is GameFightCharacterInformations) || GameFightCharacterInformations(_entities[param1]).alive))
         {
      ...
      override protected function onPropertyChanged(param1:PropertyChangeEvent) : void
      {
         ...
         {
            untargetableEntities = param1.propertyValue || Boolean(Kernel.getWorker().getFrame(FightPreparationFrame));
         }
...
class TmpFighterInfos
{
   ...
   public function TmpFighterInfos(param1:int, param2:int)
   {
      super();
