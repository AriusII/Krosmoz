         ...
         if(_loc4_)
         {
            ...
            if(_loc2_)
            {
               if(_loc4_)
               {
                  ...
                  {
                     _loc5_ = DofusEntities.getEntity(FightContextFrame.timelineOverEntityId);
                     if(_loc5_)
                     {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is GameFightSpellCastAction:
               ...
               _loc4_ = FightEntitiesFrame.getCurrentInstance().getEntityInfos(PlayedCharacterManager.getInstance().id) as GameFightFighterInformations;
            ...
            case param1 is EntityMovementCompleteMessage:
               ...
               if(_loc6_.entity.id == CurrentPlayedFighterManager.getInstance().currentFighterId)
               {
                  this._isRequestingMovement = false;
                  _loc7_ = Kernel.getWorker().getFrame(FightSpellCastFrame);
                  if(!_loc7_)
                  {
                     this.drawPath();
                  }
      ...
      public function drawPath(param1:MapPoint = null) : void
      {
         ...
         for each(_loc15_ in _loc9_.path)
         {
            ...
            else
            {
               ...
               _loc5_ += int((_loc7_ - _loc11_) * (1 - _loc3_) + 0.5);
               if(_loc5_ < 0)
               {
                  _loc5_ = 0;
               }
               _loc6_ += int(_loc8_ * (1 - _loc3_) + 0.5);
               if(_loc6_ < 0)
               {
                  _loc6_ = 0;
               }
      ...
      private function askMoveTo(param1:MapPoint) : Boolean
      {
         ...
         for each(_loc12_ in _loc3_.path)
         {
            if(_loc10_)
            {
               ...
               _loc8_ += int((_loc11_ - _loc9_) * (1 - _loc7_) + 0.5);
               if(_loc8_ < 0)
               {
                  _loc8_ = 0;
               }
