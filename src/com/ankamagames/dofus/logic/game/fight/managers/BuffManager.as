package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class BuffManager
   {
      ...
      private var _finishingBuffs:Dictionary = new Dictionary();
               ...
               if(_loc4_.duration == 1)
               {
                  ...
                  for each(_loc9_ in _loc6_.fightersList)
                  {
                     ...
                     if(_loc7_ == 1)
                     {
                        ...
                        else if(_loc9_ == param1 && _loc9_ != _loc6_.currentPlayerId)
                        {
                           _loc7_ = 2;
                           _loc5_ = false;
                        }
            ...
            if(_loc7_.stack && _loc7_.stack.length > 1 && !param4)
            {
               ...
               switch(_loc7_.actionId)
               {
                  case 293:
                     ...
                     _loc7_.param2 -= _loc7_.stack[0].param2;
                     _loc7_.param3 -= _loc7_.stack[0].param3;
                     break;
                  case 788:
                     _loc7_.param1 -= _loc7_.stack[0].param2;
                     break;
                  case 950:
                  case 951:
                     break;
