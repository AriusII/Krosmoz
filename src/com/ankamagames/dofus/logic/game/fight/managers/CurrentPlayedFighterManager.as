package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public final class CurrentPlayedFighterManager
   {
      ...
      public function set currentFighterId(param1:int) : void
      {
         ...
         if(PlayedCharacterManager.getInstance().id != param1 || Boolean(_loc2_))
         {
      ...
      public function resetPlayerSpellList() : void
      {
         ...
         this.currentFighterId = _loc1_.id;
         var _loc2_:Array = _loc1_.playerSpellList;
         if(_loc1_.spellsInventory != _loc2_)
         {
            _loc1_.spellsInventory = _loc2_;
            KernelEventsManager.getInstance().processCallback(HookList.SpellList,_loc2_);
         }
         if(_loc1_.playerShortcutList != InventoryManager.getInstance().shortcutBarSpells)
         {
            InventoryManager.getInstance().shortcutBarSpells = _loc1_.playerShortcutList;
      ...
      public function getSpellCastManagerById(param1:int) : SpellCastInFightManager
      {
         ...
         if(!_loc2_)
         {
            ...
            this._spellCastInFightManagerList[this._currentFighterId] = _loc2_;
         }
         return _loc2_;
      }
      ...
      public function canCastThisSpell(param1:uint, param2:uint, param3:int = 2147483647) : Boolean
      {
         ...
         if(param1 == 0 && _loc7_.currentWeapon != null)
         {
            ...
            _loc11_ = uint(_loc20_.apCost);
            _loc12_ = _loc20_.maxCastPerTurn;
         }
         else
         {
            _loc11_ = uint(_loc6_.apCost);
            _loc12_ = uint(_loc6_.maxCastPerTurn);
         }
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            if(Boolean(_loc5_.statesForbidden) && _loc5_.statesForbidden.indexOf(_loc16_) != -1)
            {
               return false;
            }
