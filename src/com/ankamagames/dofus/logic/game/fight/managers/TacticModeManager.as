   ...
   public class TacticModeManager
   {
      ...
      public function show(param1:WorldPointWrapper, param2:Boolean = false) : void
      {
         ...
         if(this._debugMode && this._debugCache || !this._debugMode && this._currentMapId && this._currentMapId == param1.mapId && this._cellsRef.length > 0)
         {
            ...
            _loc4_ = int(this._cellsRef.length);
            ...
            if(this._debugMode && Boolean(this._fightZone))
            {
            ...
            if(this._debugMode && Boolean(this._scaleZone))
            {
            ...
            if(this._debugMode && Boolean(this._interactiveCellsZone))
            {
         ...
         else
         {
            ...
            while(_loc3_ < _loc4_)
            {
               switch(this._cellZones[_loc3_])
               {
                  case -1:
                     ...
                     break;
                  case 0:
                     if(SHOW_BLOC_MOVE && Boolean(this.getInformations(_loc3_)[0]))
                     {
            ...
            this._tacticReachableRangeSelection.renderer = new ZoneClipRenderer(PlacementStrataEnums.STRATA_NO_Z_ORDER,SWF_LIB,TILES_REACHABLE,TILES_REACHABLE.length > 1 ? int(this._currentMapId) : -1,SHOW_BLOC_MOVE);
      ...
      public function hide(param1:Boolean = false) : void
      {
         ...
         var _loc6_:int = int(this._cellsRef.length);
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
      ...
      private function clearUnneededCells(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc7_:int = int(CellIdConverter.coordToCellId(_loc5_ / 2 + param3,_loc6_ / 2 + param4));
         ...
         while(_loc12_ < _loc13_)
         {
            ...
            if(Boolean(_loc14_[1]) || _loc9_.indexOf(_loc10_) == -1 && !_loc14_[0])
            {
      ...
      private function updateCellWithRealCellZone() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc7_:int = int(this._cellZones.length);
