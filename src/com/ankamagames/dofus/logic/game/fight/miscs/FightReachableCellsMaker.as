package com.ankamagames.dofus.logic.game.fight.miscs
{
   ...
   public class FightReachableCellsMaker
   {
      ...
      public function FightReachableCellsMaker(param1:GameFightFighterInformations, param2:int = -1, param3:int = -1)
      {
         ...
         this._mapPoint = MapPoint.fromCellId(param2 != -1 ? uint(param2) : uint(this._infos.disposition.cellId));
      ...
      private function compute() : void
      {
         ...
         while(Boolean(this._waitingCells.length) || Boolean(this._watchedCells.length))
         {
            ...
            {
               _loc2_ = int(_loc4_.bestMp * _loc4_.evade + 0.5) - 1;
      ...
      private function markNode(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(!_loc7_.set || param3 > _loc7_.bestMp || param4 > _loc7_.bestUntackledMp)
         {
            ...
            {
               this._reachableCells.push(_loc7_.mapPoint.cellId);
               _loc8_ = int(this._unreachableCells.indexOf(_loc7_.mapPoint.cellId));
               if(_loc8_ == -1)
               {
...
class _ReachableCellStore
{
   ...
   public function _ReachableCellStore(param1:MapPoint, param2:int, param3:int, param4:Vector.<Vector.<_ReachableCellStore>>)
   {
      super();
   ...
   public function findState(param1:GameFightFighterInformations) : void
   {
      ...
      else
      {
         ...
         if(this.gridX > 0)
         {
            ...
            if(Boolean(_loc3_) && _loc3_.state == STATE_UNREACHABLE)
            {
               this.evade *= _loc3_.evade;
            }
         }
