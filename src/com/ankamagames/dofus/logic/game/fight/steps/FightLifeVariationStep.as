package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightLifeVariationStep extends AbstractStatContextualStep implements IFightStep
   {
      ...
      override public function start() : void
      {
         ...
         {
            TooltipManager.updateContent("PlayerShortInfos","tooltipOverEntity_" + _loc1_.contextualId,_loc1_);
         }
         else
         {
            TooltipManager.updateContent("EntityShortInfos","tooltipOverEntity_" + _loc1_.contextualId,_loc1_);
         }
