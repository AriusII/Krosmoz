   ...
   public class BasicBuff
   {
      ...
      public function get unusableNextTurn() : Boolean
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc6_ < _loc5_)
            {
               _loc6_ += _loc1_.fightersList.length;
            }
            if(_loc4_ < _loc5_)
            {
               _loc4_ += _loc1_.fightersList.length;
            }
      ...
      public function equals(param1:BasicBuff, param2:Boolean = false) : Boolean
      {
         ...
         else
         {
            ...
            if(_loc4_ == param1.actionId && (_loc4_ == 951 || _loc4_ == 950))
            {
      ...
      public function add(param1:BasicBuff) : void
      {
         ...
         switch(this.actionId)
         {
            case 293:
               ...
               this.param3 += param1.param3;
               break;
            case 788:
               this.param1 += param1.param2;
               break;
            case 950:
            case 951:
               break;
      ...
      public function updateParam(param1:int = 0, param2:int = 0, param3:int = 0, param4:int = -1) : void
      {
         ...
         else if(Boolean(this.stack) && this.stack.length < 1)
         {
            var _loc9_:int = 0;
            var _loc10_:* = this.stack;
            for(; §§hasnext(_loc10_,_loc9_); _loc5_ += _loc8_.param1,_loc6_ += _loc8_.param2,_loc7_ += _loc8_.param3)
            {
