   ...
   public class FightEventsHelper
   {
      ...
      public static function sendFightEvent(param1:String, param2:Array, param3:int, param4:int, param5:Boolean = false, param6:int = 0, param7:int = 1) : void
      {
         ...
         else
         {
            ...
            if(Boolean(_joinedEvents) && _joinedEvents.length > 0)
            {
      ...
      private static function addFightText(param1:FightEvent) : void
      {
         ...
         var _loc2_:int = int(_events.length);
      ...
      private static function groupByElements(param1:Array, param2:int, param3:Boolean = true, param4:Boolean = false, param5:int = -1) : void
      {
         ...
         for each(_loc10_ in param1)
         {
            ...
            {
               if(Boolean(_loc9_) && _loc10_.params[2] != _loc9_)
               {
                  _loc8_ = false;
               }
               _loc9_ = int(_loc10_.params[2]);
               _loc7_ += _loc10_.params[1];
               if(param2 == -1)
               {
                  _loc6_ += formateColorsForFightDamages(_loc10_.params[1],_loc10_.params[2]) + " + ";
               }
               else
               {
                  _loc6_ += _loc10_.params[1] + " + ";
               }
            }
         }
         ...
         {
            _loc13_ += "</b> (" + _loc6_.substr(0,_loc6_.length - 3) + ")<b>";
         }
         _loc12_[1] = _loc13_;
      ...
      {
         var _loc2_:int = int(param1.params.length);
      ...
      {
         var _loc1_:int = int(_fightEvents.length - 1);
         while(_loc1_ >= 0)
         {
            if(_fightEvents[_loc1_])
            {
               _log.warn("sending " + _fightEvents[_loc1_].name);
