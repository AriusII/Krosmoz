package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayMovementFrame implements Frame
   {
      ...
      internal function setNextMoveMapChange(param1:int) : void
      {
      ...
      internal function setFollowingInteraction(param1:Object) : void
      {
      ...
      internal function askMoveTo(param1:MapPoint) : Boolean
      {
         ...
         var _loc3_:* = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id);
         ...
         {
            IMovable(_loc4_).stop();
            if(_loc4_ is AnimatedCharacter)
            {
               (_loc4_ as AnimatedCharacter).getRootEntity();
            }
            this._followingMove = param1;
            return false;
         }
         Pathfinding.findPath(DataMapProvider.getInstance(),_loc4_.position,param1,!PlayedCharacterManager.getInstance().restrictions.cantWalk8Directions,true,this.sendPath);
         return true;
      }
      ...
      internal function activateSkill(param1:uint, param2:InteractiveElement) : void
      {
