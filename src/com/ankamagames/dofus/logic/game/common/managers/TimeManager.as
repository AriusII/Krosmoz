package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class TimeManager implements IDestroyable
   {
      ...
      public function getDuration(param1:Number, param2:Boolean = false, param3:Boolean = false) : String
      {
         ...
         if(param3)
         {
            _loc14_ = Number(_loc5_.getUTCSeconds());
         }
         var _loc6_:Number = Number(_loc5_.getUTCMinutes());
         var _loc7_:Number = Number(_loc5_.getUTCHours());
         var _loc8_:Number = _loc5_.getUTCDate() - 1;
         var _loc9_:Number = Number(_loc5_.getUTCMonth());
      ...
      public function getDateFromTime(param1:Number, param2:Boolean = false) : Array
      {
         ...
         if(param2)
         {
            _loc4_ = Number(_loc3_.getDate());
            _loc5_ = _loc3_.getMonth() + 1;
            _loc6_ = Number(_loc3_.getFullYear());
            _loc7_ = Number(_loc3_.getHours());
            _loc8_ = Number(_loc3_.getMinutes());
         }
         else
         {
            _loc4_ = Number(_loc3_.getUTCDate());
            _loc5_ = _loc3_.getUTCMonth() + 1;
            _loc6_ = Number(_loc3_.getUTCFullYear());
            _loc7_ = Number(_loc3_.getUTCHours());
            _loc8_ = Number(_loc3_.getUTCMinutes());
         }
