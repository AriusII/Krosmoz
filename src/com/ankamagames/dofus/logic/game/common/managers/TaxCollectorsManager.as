package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class TaxCollectorsManager implements IDestroyable
   {
      ...
      public function setTaxCollectorsFighters(param1:Vector.<TaxCollectorFightersInformation>) : void
      {
         ...
         var _loc7_:int = int(SocialFrame.getInstance().guild.guildId);
         for each(_loc8_ in param1)
         {
            ...
            else
            {
               ...
               if(!_loc9_.guild || _loc9_.guild.guildId == _loc7_)
               {
                  ...
                  {
                     this._guildTaxCollectorsInFight[_loc8_.collectorId].update(TYPE_TAX_COLLECTOR,_loc8_.collectorId,_loc4_,_loc5_,_loc2_,_loc3_);
                  }
                  else
                  {
                     this._guildTaxCollectorsInFight[_loc8_.collectorId] = SocialEntityInFightWrapper.create(TYPE_TAX_COLLECTOR,_loc8_.collectorId,_loc4_,_loc5_,_loc2_,_loc3_);
                  }
               ...
               else
               {
                  if(this._allTaxCollectorsInPreFight[_loc8_.collectorId])
                  {
                     this._allTaxCollectorsInPreFight[_loc8_.collectorId].update(TYPE_TAX_COLLECTOR,_loc8_.collectorId,_loc4_,_loc5_,_loc2_,_loc3_);
                  }
                  else
                  {
                     this._allTaxCollectorsInPreFight[_loc8_.collectorId] = SocialEntityInFightWrapper.create(TYPE_TAX_COLLECTOR,_loc8_.collectorId,_loc4_,_loc5_,_loc2_,_loc3_);
                  }
      ...
      public function setPrismsInFight(param1:Vector.<PrismFightersInformation>) : void
      {
         ...
         for each(_loc6_ in param1)
         {
            ...
            {
               this._prismsInFight[_loc6_.subAreaId].update(TYPE_PRISM,_loc6_.subAreaId,_loc2_,_loc3_,_loc5_,_loc6_.waitingForHelpInfo.waitTimeForPlacement * 100);
            }
            else
            {
               this._prismsInFight[_loc6_.subAreaId] = SocialEntityInFightWrapper.create(TYPE_PRISM,_loc6_.subAreaId,_loc2_,_loc3_,_loc5_,_loc6_.waitingForHelpInfo.waitTimeForPlacement * 100);
            }
         }
      }
      ...
      public function addPrism(param1:PrismFightersInformation) : void
      {
         ...
         this._prismsInFight[param1.subAreaId] = SocialEntityInFightWrapper.create(TYPE_PRISM,param1.subAreaId,_loc2_,_loc3_,_loc5_,param1.waitingForHelpInfo.waitTimeForPlacement * 100);
      }
