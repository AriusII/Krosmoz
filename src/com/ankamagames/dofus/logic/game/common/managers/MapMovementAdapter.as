package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class MapMovementAdapter
   {
      ...
      public static function getServerMovement(param1:MovementPath) : Vector.<uint>
      {
         ...
         {
            _loc3_ = uint(_loc5_.orientation);
            _loc7_ = (_loc3_ & 7) << 12 | _loc5_.step.cellId & 0x0FFF;
            _loc2_.push(_loc7_);
            _loc4_++;
         }
         _loc6_ = (_loc3_ & 7) << 12 | param1.end.cellId & 0x0FFF;
         _loc2_.push(_loc6_);
         if(DEBUG_ADAPTER)
         {
            _loc8_ = "";
      ...
      public static function getClientMovement(param1:Vector.<uint>) : MovementPath
      {
         ...
         {
            _loc6_ = MapPoint.fromCellId(_loc5_ & 0x0FFF);
