package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class JobCrafterDirectoryListDialogFrame implements Frame
   {
      ...
      private static function createCrafterDirectoryListEntry(param1:JobCrafterDirectoryListEntry) : Object
      {
         ...
         _loc2_.playerInfo = param1.playerInfo;
         _loc2_.jobInfo = createCrafterDirectoryJobInfo(param1.jobInfo);
         return _loc2_;
      }
      ...
      private static function createCrafterDirectoryJobInfo(param1:JobCrafterDirectoryEntryJobInfo) : Object
      {
         ...
         _loc2_.minSlots = param1.minSlots;
         _loc2_.specialization = Job.getJobById(param1.jobId).specializationOfId > 0;
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is JobCrafterContactLookRequestAction:
               ...
               if(_loc6_.crafterId == PlayedCharacterManager.getInstance().infos.id)
               {
            ...
            case param1 is JobCrafterDirectoryListMessage:
               ...
               {
                  this._crafterList.push(createCrafterDirectoryListEntry(_loc12_));
               }
            ...
            case param1 is JobCrafterDirectoryRemoveMessage:
               ...
               while(_loc13_ < this._crafterList.length)
               {
                  ...
                  if(_loc14_.jobInfo.jobId == _loc8_.jobId && _loc14_.playerInfo.playerId == _loc8_.playerId)
                  {
            ...
            case param1 is JobCrafterDirectoryAddMessage:
               ...
               {
                  if(_loc9_.listEntry.playerInfo.playerId == this._crafterList[_loc15_].playerInfo.playerId)
                  {
                     this._crafterList.splice(_loc15_,1);
                  }
               }
               this._crafterList.push(createCrafterDirectoryListEntry(_loc9_.listEntry));
               KernelEventsManager.getInstance().processCallback(CraftHookList.CrafterDirectoryListUpdate,this._crafterList);
               return true;
