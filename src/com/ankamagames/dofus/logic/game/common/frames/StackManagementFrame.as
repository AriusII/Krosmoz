package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class StackManagementFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is AddBehaviorToStackAction:
               ...
               for each(_loc9_ in _loc2_.behavior)
               {
                  switch(_loc9_)
                  {
            ...
            default:
                     ...
                     switch(true)
                     {
                        ...
                        case _loc10_ is InteractiveElementBehavior:
                           ...
                           if(_loc6_ && _loc13_.interactiveElement.elementId == (param1 as Object).elemId)
                           {
                              ...
                              _loc14_ = int(this._stackOutputMessage.indexOf(_loc13_));
                              _loc15_ = this._waitingMessage as InteractiveElementActivationMessage;
                              if((Boolean(_loc15_)) && _loc15_.interactiveElement.elementId == _loc13_.interactiveElement.elementId)
                              {
               ...
               if(this._stopMessages.indexOf(_loc5_) != -1)
               {
                  ...
                  if(_loc16_)
                  {
                     _log.error("Just catched a stop message: " + _loc5_);
                     this.emptyStack();
                     return false;
                  }
               }
      ...
      private function getSameInOutputList(param1:AbstractBehavior) : AbstractBehavior
      {
         ...
         {
            if(Boolean(_loc2_.getMapPoint()) && _loc2_.getMapPoint().cellId == param1.getMapPoint().cellId)
            {
               return _loc2_;
            }
         }
      ...
      private function removeCheckPoint(param1:AbstractBehavior) : void
      {
         ...
         if(this._checkPointList.length > 0)
         {
            ...
            {
               if(Boolean(param1.getMapPoint()) && param1.getMapPoint().cellId == _loc2_.position.cellId)
               {
