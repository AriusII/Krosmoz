package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class MountFrame implements Frame
   {
      ...
      {
         var _loc2_:MountInformationInPaddockRequestAction = null;
         var _loc3_:MountInformationInPaddockRequestMessage = null;
         var _loc4_:IMovable = null;
         var _loc5_:MountFeedRequestAction = null;
         var _loc6_:MountReleaseRequestMessage = null;
         var _loc7_:MountSterilizeRequestMessage = null;
         var _loc8_:MountRenameRequestAction = null;
         var _loc9_:MountRenameRequestMessage = null;
         var _loc10_:MountSetXpRatioRequestAction = null;
         var _loc11_:MountSetXpRatioRequestMessage = null;
         var _loc12_:MountInfoRequestAction = null;
         var _loc13_:MountInformationRequestMessage = null;
         var _loc14_:ExchangeRequestOnMountStockMessage = null;
         ...
         var _loc23_:ExchangeMountStableAddMessage = null;
         var _loc24_:ExchangeMountStableRemoveMessage = null;
         var _loc25_:ExchangeMountPaddockAddMessage = null;
         var _loc26_:ExchangeMountPaddockRemoveMessage = null;
         var _loc27_:MountDataMessage = null;
         ...
         var _loc46_:UpdateMountBoost = null;
         var _loc47_:UpdateMountIntBoost = null;
         var _loc48_:String = null;
         var _loc49_:SerialSequencer = null;
         switch(true)
         {
            case param1 is MountInformationInPaddockRequestAction:
               _loc2_ = param1 as MountInformationInPaddockRequestAction;
               _loc3_ = new MountInformationInPaddockRequestMessage();
               _loc3_.initMountInformationInPaddockRequestMessage(_loc2_.mountId);
               ConnectionsHandler.getConnection().send(_loc3_);
               return true;
            case param1 is MountToggleRidingRequestAction:
               _loc4_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id) as IMovable;
               if((Boolean(_loc4_)) && !_loc4_.isMoving)
               {
            ...
            case param1 is MountFeedRequestAction:
               _loc5_ = param1 as MountFeedRequestAction;
               if(Kernel.getWorker().getFrame(FightBattleFrame) == null)
               {
                  _loc43_ = new MountFeedRequestMessage();
                  _loc43_.initMountFeedRequestMessage(_loc5_.mountId,_loc5_.mountLocation,_loc5_.mountFoodUid,_loc5_.quantity);
                  ConnectionsHandler.getConnection().send(_loc43_);
               }
               return true;
            case param1 is MountReleaseRequestAction:
               _loc6_ = new MountReleaseRequestMessage();
               _loc6_.initMountReleaseRequestMessage();
               ConnectionsHandler.getConnection().send(_loc6_);
               return true;
            case param1 is MountSterilizeRequestAction:
               _loc7_ = new MountSterilizeRequestMessage();
               _loc7_.initMountSterilizeRequestMessage();
               ConnectionsHandler.getConnection().send(_loc7_);
               return true;
            case param1 is MountRenameRequestAction:
               _loc8_ = param1 as MountRenameRequestAction;
               _loc9_ = new MountRenameRequestMessage();
               _loc9_.initMountRenameRequestMessage(!!_loc8_.newName ? _loc8_.newName : "",_loc8_.mountId);
               ConnectionsHandler.getConnection().send(_loc9_);
               return true;
            case param1 is MountSetXpRatioRequestAction:
               _loc10_ = param1 as MountSetXpRatioRequestAction;
               _loc11_ = new MountSetXpRatioRequestMessage();
               _loc11_.initMountSetXpRatioRequestMessage(_loc10_.xpRatio > MAX_XP_RATIO ? MAX_XP_RATIO : _loc10_.xpRatio);
               ConnectionsHandler.getConnection().send(_loc11_);
               return true;
            case param1 is MountInfoRequestAction:
               _loc12_ = param1 as MountInfoRequestAction;
               _loc13_ = new MountInformationRequestMessage();
               _loc13_.initMountInformationRequestMessage(_loc12_.mountId,_loc12_.time);
               ConnectionsHandler.getConnection().send(_loc13_);
               return true;
            case param1 is ExchangeRequestOnMountStockAction:
               _loc14_ = new ExchangeRequestOnMountStockMessage();
               _loc14_.initExchangeRequestOnMountStockMessage();
            ...
            case param1 is MountSterilizedMessage:
               ...
               _loc15_ = MountData.getMountFromCache(_loc17_);
               if(_loc15_)
               {
                  _loc15_.reproductionCount = -1;
               }
            ...
            case param1 is ExchangeMountStableBornAddMessage:
               ...
               _loc22_ = MountData.makeMountData(_loc21_.mountDescription,true,this._mountXpRatio);
               _loc22_.borning = true;
               if(this._stableList)
               {
                  this._stableList.push(_loc22_);
               }
               KernelEventsManager.getInstance().processCallback(MountHookList.MountStableUpdate,this._stableList,null,null);
               return true;
            case param1 is ExchangeMountStableAddMessage:
               _loc23_ = param1 as ExchangeMountStableAddMessage;
               if(this._stableList)
               {
                  this._stableList.push(MountData.makeMountData(_loc23_.mountDescription,true,this._mountXpRatio));
               }
               KernelEventsManager.getInstance().processCallback(MountHookList.MountStableUpdate,this._stableList,null,null);
               return true;
            case param1 is ExchangeMountStableRemoveMessage:
               _loc24_ = param1 as ExchangeMountStableRemoveMessage;
               _loc44_ = 0;
               while(_loc44_ < this._stableList.length)
               {
                  if(this._stableList[_loc44_].id == _loc24_.mountId)
                  {
            ...
            case param1 is ExchangeMountPaddockAddMessage:
               _loc25_ = param1 as ExchangeMountPaddockAddMessage;
               this._paddockList.push(MountData.makeMountData(_loc25_.mountDescription,true,this._mountXpRatio));
            ...
            case param1 is ExchangeMountPaddockRemoveMessage:
               _loc26_ = param1 as ExchangeMountPaddockRemoveMessage;
               _loc44_ = 0;
               while(_loc44_ < this._paddockList.length)
               {
                  if(this._paddockList[_loc44_].id == _loc26_.mountId)
                  {
            ...
            case param1 is MountXpRatioMessage:
               ...
               _loc15_ = PlayedCharacterManager.getInstance().mount;
               if(_loc15_)
               {
                  _loc15_.xpRatio = this._mountXpRatio;
               }
            ...
            case param1 is MountDataMessage:
               _loc27_ = param1 as MountDataMessage;
               if(this._mountDialogFrame.inStable)
               {
                  KernelEventsManager.getInstance().processCallback(MountHookList.CertificateMountData,MountData.makeMountData(_loc27_.mountData,false,this.mountXpRatio));
               }
               else
               {
                  KernelEventsManager.getInstance().processCallback(MountHookList.PaddockedMountData,MountData.makeMountData(_loc27_.mountData,false,this.mountXpRatio));
               }
               return true;
            case param1 is MountRidingMessage:
               _loc28_ = MountRidingMessage(param1).isRiding;
               _loc29_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id) as AnimatedCharacter;
               if(_loc29_)
               {
                  _loc29_.setAnimation(AnimationEnum.ANIM_STATIQUE);
               }
               PlayedCharacterManager.getInstance().isRidding = _loc28_;
               KernelEventsManager.getInstance().processCallback(MountHookList.MountRiding,_loc28_);
               return true;
            ...
            case param1 is UpdateMountBoostMessage:
               ...
               _loc36_ = null;
               for each(_loc45_ in this._paddockList)
               {
                  if(_loc45_.id == _loc35_.rideId)
                  {
                     _loc36_ = _loc45_;
                     break;
                  }
               ...
               for each(_loc46_ in _loc35_.boostToUpdateList)
               {
                  if(_loc46_ is UpdateMountIntBoost)
                  {
                     _loc47_ = _loc46_ as UpdateMountIntBoost;
                     switch(_loc47_.type)
                     {
                        case UpdatableMountBoostEnum.ENERGY:
                           _loc36_.energy = _loc47_.value;
                           break;
                        case UpdatableMountBoostEnum.LOVE:
                           _loc36_.love = _loc47_.value;
                           break;
                        case UpdatableMountBoostEnum.MATURITY:
                           _loc36_.maturity = _loc47_.value;
                           break;
                        case UpdatableMountBoostEnum.SERENITY:
                           _loc36_.serenity = _loc47_.value;
                           break;
                        case UpdatableMountBoostEnum.STAMINA:
                           _loc36_.stamina = _loc47_.value;
                           break;
                        case UpdatableMountBoostEnum.TIREDNESS:
                           _loc36_.boostLimiter = _loc47_.value;
                     }
                  }
               }
               KernelEventsManager.getInstance().processCallback(MountHookList.MountStableUpdate,null,this._paddockList,null);
            ...
            case param1 is MountEmoteIconUsedOkMessage:
               ...
               if(_loc38_)
               {
                  ...
                  {
                     case 1:
                        _loc48_ = "AnimEmoteRest_Statique";
                        break;
                     case 2:
                        _loc48_ = "AnimAttaque0";
                        break;
                     case 3:
                        _loc48_ = "AnimEmoteCaresse";
                        break;
                     case 4:
                        _loc48_ = "AnimEmoteReproductionF";
                        break;
                     case 5:
                        _loc48_ = "AnimEmoteReproductionM";
                  }
                  if(_loc48_)
                  {
                     _loc49_ = new SerialSequencer();
                     _loc49_.addStep(new PlayAnimationStep(_loc38_,_loc48_,false));
                     _loc49_.addStep(new SetAnimationStep(_loc38_,AnimationEnum.ANIM_STATIQUE));
                     _loc49_.start();
                  }
               }
               return true;
