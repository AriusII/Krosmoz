package com.ankamagames.dofus.logic.game.common.misc.inventoryView
{
   ...
   public class StorageGenericView implements IStorageView
   {
      ...
      public function addItem(param1:ItemWrapper, param2:int) : void
      {
         ...
         if(Boolean(this._typesQty[param1.typeId]) && this._typesQty[param1.typeId] > 0)
         {
      ...
      public function updateView() : void
      {
         ...
         if(Boolean(this._sortFieldsCache) && this._sortFieldsCache.length == this.sortFields().length)
         {
            _loc3_ = int(this._sortFieldsCache.length);
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
