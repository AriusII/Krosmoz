package com.ankamagames.dofus.logic.game.common.misc.inventoryView
{
   ...
   public class StorageSmithMagicFilterView extends StorageGenericView
   {
      ...
      override public function isListening(param1:ItemWrapper) : Boolean
      {
         ...
         return Boolean(this._parent.isListening(param1)) && super.isListening(param1) && (_loc2_.typeId == this._skill.modifiableItemType || _loc2_.typeId == SMITHMAGIC_RUNE_ID || _loc2_.typeId == SMITHMAGIC_POTION_ID || param1.objectGID == SIGNATURE_RUNE_ID);
      }
