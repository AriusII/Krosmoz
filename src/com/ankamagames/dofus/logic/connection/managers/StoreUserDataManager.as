package com.ankamagames.dofus.logic.connection.managers
{
   ...
   public class StoreUserDataManager
   {
      ...
      public function savePlayerData() : void
      {
         ...
         {
            _loc9_ += _loc10_.key + ":" + _loc10_.value + ";";
         }
         _loc9_ += "isAbo:" + (PlayerManager.getInstance().subscriptionEndDate > 0 || PlayerManager.getInstance().hasRights) + ";";
         ...
         else if(_loc11_.search("mac") != -1)
         {
            _loc9_ += "mac";
         }
         else if(_loc11_.search("linux") != -1)
         {
            _loc9_ += "linux";
         }
         else
         ...
         if(Boolean(this._so.data) && (this._so.data == _loc12_ || arguments && arguments.length == 0 && this._so.data.length != 0))
         {
            return;
         }
