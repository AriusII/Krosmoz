package com.ankamagames.dofus.logic.common.frames
{
   ...
   public class LoadingModuleFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is UiXmlParsedMessage:
               ...
               this._loadingScreen.value += (_loc6_ - this._lastXmlParsedPrc) * 100 * this._progressRation;
            ...
            case param1 is MapRenderProgressMessage:
               this._loadingScreen.value += MapRenderProgressMessage(param1).percent * this._progressRation;
               return true;
      ...
      private function launchGame() : void
      {
         ...
         var _loc1_:int = int(DisconnectionHandlerFrame.messagesAfterReset.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
