package com.ankamagames.dofus.internalDatacenter.guild
{
   ...
   public class AllianceWrapper implements IDataCenter
   {
      ...
      public var guilds:Vector.<GuildFactSheetWrapper> = new Vector.<GuildFactSheetWrapper>();
      
      public var prismIds:Vector.<uint> = new Vector.<uint>();
      ...
      private static function getFromAllianceFactsMessage(param1:AllianceFactsMessage) : AllianceWrapper
      {
         ...
         if(Boolean(param1.guilds) && param1.guilds.length > 0)
         {
         ...
         {
            _loc2_.nbMembers += param1.guilds[_loc3_].nbMembers;
      ...
      public static function getRightsNumber(param1:Array) : Number
      {
         ...
         for each(_loc3_ in allianceRights)
         {
            ...
            for each(_loc5_ in param1)
            {
               if(_loc5_ == _loc3_)
               {
                  _loc2_ |= 1 << _rightDictionnary[_loc5_];
               }
            }
         }
         return _loc2_;
