package com.ankamagames.dofus.externalnotification
{
   ...
   public class ExternalNotificationRequest
   {
      ...
      public static function createFromJSONString(param1:String) : ExternalNotificationRequest
      {
         ...
         return new ExternalNotificationRequest(_loc2_.notificationType,_loc2_.clientId,_loc2_.otherClientsIds,_loc2_.id,_loc2_.showMode,_loc2_.uiName,_loc2_.displayData,_loc2_.soundId,_loc2_.playSound,_loc2_.notify,_loc2_.hookName,_loc2_.hookParams);
      }
