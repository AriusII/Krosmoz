package com.ankamagames.dofus.externalnotification
{
   ...
   public class ExternalNotificationManager
   {
      ...
      public function init() : void
      {
         ...
         x = describeType(ExternalNotificationTypeEnum);
         events = x..constant;
         for each(notificationEvent in events)
         {
            notificationType = int(ExternalNotificationTypeEnum[notificationEvent.@name]);
      ...
      {
         var _loc1_:int = int(this._notificationsList.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      {
         if(Boolean(this._clientWindow.active) && param2)
         {
      ...
      public function handleNotificationRequest(param1:Object) : void
      {
         ...
         if(this._clientId == _loc2_.clientId && _loc2_.showMode != ExternalNotificationModeEnum.ALWAYS)
         {
            ...
            if(!_loc3_ && Boolean(this._clientWindow.active))
            {
               _loc3_ = true;
            }
      ...
      private function processRequests(param1:TimerEvent) : void
      {
         ...
         bufferLen = int(this._buffer.length);
      ...
      private function setNotificationCoordinates(param1:ExternalNotificationWindow) : void
      {
         ...
         var _loc2_:int = int(this._notificationsList.indexOf(param1));
      ...
      private function destroyExternalNotification(param1:ExternalNotificationWindow, param2:Boolean = true) : void
      {
         ...
         param1.destroy();
         var _loc3_:int = int(this._notificationsList.length);
         var _loc5_:int = int(this._notificationsList.indexOf(param1));
         if(param2)
         {
            if(this._notificationsList.length > 0 && _loc5_ != _loc3_ - 1)
            {
               ...
               while(_loc4_ > _loc5_)
               {
                  this._notificationsList[_loc4_].y += _loc6_;
                  _loc4_--;
               }
            }
         }
