package com.ankamagames.dofus.modules.utils
{
   ...
   public class ModuleFileManager
   {
      ...
      private var _moduleSizes:Dictionary = new Dictionary();
      
      private var _moduleFilesNum:Dictionary = new Dictionary();
      ...
      public function updateModuleSize(param1:String, param2:int) : void
      {
         ...
         this._moduleSizes[param1] += param2;
      }
      
      public function updateModuleFileNum(param1:String, param2:int) : void
      {
         this.initModuleFiles(param1);
         this._moduleFilesNum[param1] += param2;
      }
      ...
      private function updateFolderSize(param1:File, param2:String) : void
      {
         ...
         this._moduleSizes[param2] += _loc3_;
         this._moduleFilesNum[param2] += _loc4_.length;
      }
   }
}
