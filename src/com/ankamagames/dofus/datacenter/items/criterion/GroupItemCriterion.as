   ...
   public class GroupItemCriterion implements IItemCriterion, IDataCenter
   {
      ...
      public static function create(param1:Vector.<IItemCriterion>, param2:Vector.<String>) : GroupItemCriterion
      {
         ...
         while(_loc7_ < _loc3_)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc4_ += (param1[_loc5_++] as IItemCriterion).basicText;
            }
            else
            {
         ...
         return new GroupItemCriterion(_loc4_);
      }
      ...
      private function split() : void
      {
         ...
         var _loc11_:IItemCriterion = null;
         var _loc12_:int = 0;
         ...
         if(_loc6_.length == 0 || _loc7_.length == 0)
         {
            ...
            while(!_loc4_)
            {
               ...
               else
               {
                  ...
                  _loc9_ = int(_loc5_.indexOf(_loc8_.basicText));
                  _loc10_ = _loc5_.slice(_loc9_ + _loc8_.basicText.length,_loc9_ + 1 + _loc8_.basicText.length);
                  if(_loc10_)
                  {
                     this._operators.push(_loc10_);
                  }
                  _loc5_ = _loc5_.slice(_loc9_ + 1 + _loc8_.basicText.length);
               }
            }
         }
         else
         {
            while(!_loc4_)
            {
               ...
               {
                  _loc11_ = this.getFirstCriterion(_loc5_);
                  if(!_loc11_)
                  {
                     _loc4_ = true;
                  }
                  ...
                  {
                     this._criteria.push(_loc11_);
                     _loc3_ = 1;
                     _loc12_ = int(_loc5_.indexOf(_loc11_.basicText));
                     _loc13_ = _loc5_.slice(0,_loc12_);
                     _loc14_ = _loc5_.slice(_loc12_ + _loc11_.basicText.length);
                     _loc5_ = _loc13_ + _loc14_;
                  }
               }
               else
               {
                  _loc15_ = _loc5_.slice(0,1);
                  if(!_loc15_)
                  {
                     _loc4_ = true;
                  }
