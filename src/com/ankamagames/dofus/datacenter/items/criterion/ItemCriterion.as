package com.ankamagames.dofus.datacenter.items.criterion
{
   ...
   public class ItemCriterion implements IItemCriterion, IDataCenter
   {
      ...
      public function get text() : String
      {
         ...
         {
            case "CM":
               _loc1_ = I18n.getUiText("ui.stats.MP");
               break;
            case "CP":
               _loc1_ = I18n.getUiText("ui.stats.AP");
               break;
            case "CH":
      ...
      protected function getCriterion() : int
      {
         ...
         switch(this._criterionRef)
         {
            ...
            case "CC":
               ...
               break;
            case "Ce":
               _loc1_ = int(_loc2_.characteristics.energyPoints);
               break;
            case "CE":
               _loc1_ = int(_loc2_.characteristics.maxEnergyPoints);
               break;
            case "CH":
               _loc1_ = int(_loc2_.characteristics.alignmentInfos.honor);
               break;
            case "Ci":
            ...
            case "CI":
               ...
               break;
            case "CL":
               _loc1_ = int(_loc2_.characteristics.lifePoints);
               break;
            case "CM":
