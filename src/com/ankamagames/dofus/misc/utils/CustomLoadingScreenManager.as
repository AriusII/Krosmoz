package com.ankamagames.dofus.misc.utils
{
   ...
   public class CustomLoadingScreenManager
   {
      ...
      public function loadCustomScreenList() : void
      {
         ...
         _loc2_ = new Uri(XmlConfig.getInstance().getEntry("config.customLoadingScreen") + "loadingScreen_" + _loc1_ + ".xml");
