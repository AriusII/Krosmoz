package com.ankamagames.dofus.misc.utils
{
   ...
   public class StatisticReportingManager
   {
      ...
      protected var _log:Logger = Log.getLogger(getQualifiedClassName(StatisticReportingManager));
      
      private var _dt:DataStoreType = new DataStoreType("StatisticReportingManager",true,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER);
      ...
      public function report(param1:String, param2:String) : Boolean
      {
         ...
         try
         {
            ...
            if(Boolean(_loc3_) && _loc3_ == param2)
            {
               return false;
            }
