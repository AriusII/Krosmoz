package com.ankamagames.berilia.components
{
   ...
   public class ColorPicker extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      public function getGradientColor() : uint
      {
         ...
         _loc9_ = Number(this._aColorsHue[_loc14_]);
         _loc10_ = Number(this._aColorsHue[_loc14_ + 1]);
         _loc3_ = _loc9_ & 0xFF0000;
         _loc4_ = _loc9_ & 0xFF00;
         _loc5_ = _loc9_ & 0xFF;
         _loc6_ = _loc10_ & 0xFF0000;
         _loc7_ = _loc10_ & 0xFF00;
         _loc8_ = _loc10_ & 0xFF;
         if(_loc3_ != _loc6_)
         {
         ...
         _loc11_ += (127 - _loc11_) * _loc1_ / 255;
         _loc12_ += (127 - _loc12_) * _loc1_ / 255;
         _loc13_ += (127 - _loc13_) * _loc1_ / 255;
      ...
      private function getCurrentColor() : uint
      {
         ...
         if(!this._bFixedColor)
         {
            ...
            _loc2_ = (this._nGradientColor & 0xFF0000) >> 16;
            _loc3_ = (this._nGradientColor & 0xFF00) >> 8;
            _loc4_ = this._nGradientColor & 0xFF;
            if(_loc1_ >= 0)
            {
