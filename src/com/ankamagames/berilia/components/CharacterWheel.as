   ...
   public class CharacterWheel extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      override public function remove() : void
      {
         ...
         if(!__removed)
         {
            ...
            _loc2_ = int(this._aSprites.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
            ...
            {
               _loc6_ = uint(this._charaSelCtr.numChildren);
               while(_loc6_ > 0)
               {
      ...
      private function charactersDisplay() : void
      {
         ...
         var _loc1_:int = int(this._aSprites.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
         ...
         {
            _loc5_ = uint(this._aMountainsCtr.numChildren);
            _loc6_ = int(_loc5_ - 1);
            while(_loc6_ >= 0)
            {
         ...
         else
         {
            ...
            while(_loc8_ < this._nNbCharacters)
            {
               if(this._aCharactersList[_loc8_])
               {
                  ...
                  _loc12_ = new CBI(this._aCharactersList[_loc8_].id,this._aCharactersList[_loc8_].gfxId,this._aCharactersList[_loc8_].breed,new Array());
      ...
      private function rotateMountains(param1:int) : void
      {
         ...
         {
            this._nSelectedChara -= this._aCharactersList.length;
         }
         ...
         {
            this._nRotationPieceTrg += this._nRotationStep * this._sens;
         }
         if(param1 == 1)
         {
      ...
      private function onRotateMountains(param1:Event) : void
      {
         ...
         {
            this._nRotation += (this._nRotationPieceTrg - this._nRotation) / 3;
         }
...
class TiphonEntity extends TiphonSprite implements IEntity
{
   ...
   public function TiphonEntity(param1:uint, param2:TiphonEntityLook)
   {
      super(param2);
      this._id = param1;
      mouseEnabled = false;
...
class CBI
{
   ...
   public function CBI(param1:uint, param2:int, param3:int, param4:Array)
   {
      super();
      this.id = param1;
      this.gfxId = param2;
