package com.ankamagames.berilia.components
{
   ...
   public class Label extends GraphicContainer implements UIComponent, IRectangle, FinalizableUIComponent
   {
      ...
      public function applyCSS(param1:Uri) : void
      {
         ...
         if(param1 == this._sCssUrl && Boolean(this._tfFormatter))
         {
            this.updateCss();
         }
         else
      ...
      {
         super.remove();
         if(Boolean(this._tText) && Boolean(this._tText.parent))
         {
      ...
      public function appendText(param1:String, param2:String = null) : void
      {
         ...
         if(Boolean(param2) && Boolean(this.aStyleObj[param2]))
         {
      ...
      private function bindCss() : void
      {
         ...
         if(Boolean(this.aStyleObj[_loc3_]["shadowSize"]) || Boolean(this.aStyleObj[_loc3_]["shadowColor"]))
         {
            _loc5_ = !!this.aStyleObj[_loc3_]["shadowColor"] ? uint(parseInt(this.aStyleObj[_loc3_]["shadowColor"].substr(1))) : 0;
            _loc6_ = !!this.aStyleObj[_loc3_]["shadowSize"] ? uint(parseInt(this.aStyleObj[_loc3_]["shadowSize"])) : 5;
         ...
         this.updateAlign();
         if(this._useExtendWidth && Boolean(getUi()))
         {
            getUi().render();
         }
         this._binded = true;
      ...
      public function resizeText(param1:Boolean = true) : void
      {
         ...
         this.removeTooltipExtension();
         if(this._bFixedHeight && !this._tText.multiline && this._tText.autoSize == "none" && Boolean(this._tfFormatter))
         {
      ...
      protected function updateAlign() : void
      {
         ...
         {
            _loc1_ += TextLineMetrics(this._tText.getLineMetrics(_loc2_)).height + TextLineMetrics(this._tText.getLineMetrics(_loc2_)).leading + TextLineMetrics(this._tText.getLineMetrics(_loc2_)).descent;
            _loc2_++;
         }
