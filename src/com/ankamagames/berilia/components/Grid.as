package com.ankamagames.berilia.components
{
   ...
   public class Grid extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      {
         if(Boolean(this._scrollBarH) && this._scrollBarH.visible)
         {
            this._scrollBarH.value = this._pageXOffset;
         }
         if(Boolean(this._scrollBarV) && this._scrollBarV.visible)
         {
      ...
      public function set autoSelect(param1:Boolean) : void
      {
         ...
         if(Boolean(this._dataProvider.length) && this._autoSelect == AUTOSELECT_BY_INDEX)
         {
      ...
      public function finalize() : void
      {
         ...
         if(Boolean(this._hiddenCol) || Boolean(this._hiddenRow))
         {
            if(!this._mask)
            {
      ...
      private function initSlot() : void
      {
         ...
         var _loc2_:int = 0;
         if(Boolean(this._dataProvider.length) && !this._autoPosition)
         {
      ...
      internal function setSelectedIndex(param1:int, param2:uint) : void
      {
         var _loc3_:int = 0;
         var _loc4_:GridItem = null;
      ...
      private function getGridItem(param1:DisplayObject) : GridItem
      {
         ...
         while(Boolean(_loc3_) && _loc3_.parent != this)
         {
      ...
      private function getNearestSlot(param1:MouseEvent) : Slot
      {
         ...
         {
            _loc5_ = int(GridItem(this._items[_loc14_]).index);
      ...
      private function onListWheel(param1:MouseEvent) : void
      {
         ...
         else if(Boolean(this._scrollBarH) && this._scrollBarH.visible)
         {
         ...
         switch(true)
         {
            ...
            case param1 is MouseOverMessage:
               ...
               if(_loc2_)
               {
                  ...
                  {
                     if(Boolean(parent) && parent is ComboBox)
                     {
            ...
            case param1 is KeyboardKeyDownMessage:
               ...
               switch(_loc9_.keyboardEvent.keyCode)
               {
                  case Keyboard.UP:
                     ...
                     _loc11_ = int(SelectMethodEnum.UP_ARROW);
                     break;
                  case Keyboard.DOWN:
                     _loc10_ = this.selectedIndex + this._totalSlotByRow;
                     _loc11_ = int(SelectMethodEnum.DOWN_ARROW);
                     break;
                  case Keyboard.RIGHT:
                     _loc10_ = this.selectedIndex + 1;
                     _loc11_ = int(SelectMethodEnum.RIGHT_ARROW);
                     break;
                  case Keyboard.LEFT:
                     _loc10_ = this.selectedIndex - 1;
                     _loc11_ = int(SelectMethodEnum.LEFT_ARROW);
               }
               if(_loc11_ != -1)
               {
