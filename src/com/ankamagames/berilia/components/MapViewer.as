package com.ankamagames.berilia.components
{
   ...
   public class MapViewer extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      private var _arrowPool:Array = new Array();
      
      private var _arrowAllocation:Dictionary = new Dictionary();
      
      private var _reverseArrowAllocation:Dictionary = new Dictionary();
      
      private var _mapGroupElements:Dictionary = new Dictionary();
      ...
      private var _debugCtr:Sprite = new Sprite();
      ...
      public function finalize() : void
      {
         ...
         if(Boolean(this._arrowPool) && Boolean(this._arrowAllocation))
         {
      ...
      public function addIcon(param1:String, param2:String, param3:*, param4:int, param5:int, param6:Number = 1, param7:String = null, param8:Boolean = false, param9:int = -1, param10:Boolean = true) : MapIconElement
      {
         ...
         if(Boolean(this._layers[param1]) && this.mapBounds.contains(param4,param5))
         {
            if(param3 is String)
            {
            ...
            if(param9 != -1)
            {
               _loc14_ = param9 >> 16 & 0xFF;
               _loc15_ = param9 >> 8 & 0xFF;
               _loc16_ = param9 >> 0 & 0xFF;
      ...
      public function addAreaShape(param1:String, param2:String, param3:Vector.<int>, param4:uint = 0, param5:Number = 1, param6:uint = 0, param7:Number = 0.4, param8:int = 4) : MapAreaShape
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         if(Boolean(this._layers[param1]) && Boolean(param3))
         {
      ...
      public function getMapElementsByLayer(param1:String) : Array
      {
         ...
         var _loc2_:int = int(this._mapElements.length);
      ...
      public function removeMapElement(param1:MapElement) : void
      {
         ...
         var _loc2_:int = int(this._mapElements.indexOf(param1));
         if(_loc2_ != -1)
         {
            ...
            if(param1 is MapIconElement)
            {
               ...
               if(Boolean(this._arrowAllocation[_loc4_]) && Boolean(this._arrowAllocation[_loc4_].parent))
               {
                  ...
                  switch(true)
                  {
                     case _loc2_ is MapIconElement:
                        ...
                        if(_loc4_.length != 1 && _loc7_.canBeGrouped)
                        {
                           if(!_loc6_)
                           {
                              _loc6_ = new MapGroupElement(_loc7_._texture.width * 1.5,_loc7_._texture.height * 1.5);
      ...
      public function zoom(param1:Number, param2:Point = null) : void
      {
         ...
         if(Boolean(this._currentMap) && (this._currentMap.initialWidth * param1 < width || this._currentMap.initialHeight * param1 < height))
         {
            return;
         }
         if(param2)
         {
            ...
            this._mapContainer.x -= param2.x * param1 - param2.x * this._mapContainer.scaleX;
            this._mapContainer.y -= param2.y * param1 - param2.y * this._mapContainer.scaleY;
      ...
      public function removeAllMap() : void
      {
         ...
         for each(_loc1_ in this._avaibleMap)
         {
         ...
         for each(_loc13_ in this._mapElements)
         {
            ...
            if(_loc3_)
            {
               ...
               if(_loc2_)
               {
                  ...
                  if(_loc3_.follow)
                  {
                     if(_loc2_.visible && Boolean(this._arrowAllocation[_loc2_]))
                     {
      ...
      private function processMapInfo() : void
      {
         ...
         for each(_loc4_ in this._avaibleMap)
         {
      ...
      private function updateVisibleChunck() : void
      {
         ...
         this._viewRect.width = width / this._mapContainer.scaleX + 100 * 2;
         this._viewRect.height = height / this._mapContainer.scaleY + 100 * 2;
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is MouseOverMessage:
               ...
               if(Boolean(this._reverseArrowAllocation[_loc2_.target]) && Boolean(this._elementsGraphicRef[this._reverseArrowAllocation[_loc2_.target]]))
               {
            ...
            case param1 is MouseOutMessage:
               ...
               if(Boolean(this._reverseArrowAllocation[_loc3_.target]) && Boolean(this._elementsGraphicRef[this._reverseArrowAllocation[_loc3_.target]]))
               {
            ...
            case param1 is MouseWheelMessage:
               ...
               _loc6_ = this._mapContainer.scaleX + (_loc5_.mouseEvent.delta > 0 ? 1 : -1) * 0.2;
            ...
            case param1 is MouseRightClickMessage:
               ...
               else if(Boolean(this._reverseArrowAllocation[_loc8_.target]) && Boolean(this._elementsGraphicRef[this._reverseArrowAllocation[_loc8_.target]]))
               {
      ...
      private function onMapEnterFrame(param1:Event) : void
      {
         ...
         if(this._draging)
         {
            if(this._enable3DMode && Boolean(this._lastMouseX))
            {
               this._mapContainer.x -= StageShareManager.mouseX - this._lastMouseX;
               this._mapContainer.y -= StageShareManager.mouseY - this._lastMouseY;
            }
            this.updateVisibleChunck();
