   ...
   public class TreeGridRenderer implements IGridRenderer
   {
      ...
      public function render(param1:*, param2:uint, param3:Boolean, param4:uint = 0) : DisplayObject
      {
         ...
         if(_loc6_)
         {
            ...
            if(Boolean(_loc6_.children) && Boolean(_loc6_.children.length))
            {
         ...
         if(param1 && Boolean(param1.value.hasOwnProperty("css")))
         {
      ...
      private function updateBackground(param1:Sprite, param2:uint, param3:Boolean) : void
      {
         ...
         if(param3 && Boolean(this._selectedColor))
         {
      ...
      private function onRollOver(param1:MouseEvent) : void
      {
         ...
         if(param1.target.name.indexOf("extension") == -1 && Boolean(param1.target.text.length))
         {
