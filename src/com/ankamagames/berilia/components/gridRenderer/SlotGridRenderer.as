package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class SlotGridRenderer implements IGridRenderer, ICustomSecureObject
   {
      ...
      public function SlotGridRenderer(param1:String)
      {
         ...
         this._emptyTexture = Boolean(_loc2_[0]) && Boolean(_loc2_[0].length) ? new Uri(_loc2_[0]) : null;
         this._overTexture = Boolean(_loc2_[1]) && Boolean(_loc2_[1].length) ? new Uri(_loc2_[1]) : null;
         this._selectedTexture = Boolean(_loc2_[2]) && Boolean(_loc2_[2].length) ? new Uri(_loc2_[2]) : null;
         this._acceptDragTexture = Boolean(_loc2_[3]) && Boolean(_loc2_[3].length) ? new Uri(_loc2_[3]) : null;
         this._refuseDragTexture = Boolean(_loc2_[4]) && Boolean(_loc2_[4].length) ? new Uri(_loc2_[4]) : null;
         this._timerTexture = Boolean(_loc2_[5]) && Boolean(_loc2_[5].length) ? new Uri(_loc2_[5]) : null;
         this._cssUri = Boolean(_loc2_[6]) && Boolean(_loc2_[6].length) ? new Uri(_loc2_[6]) : null;
         this._allowDrop = Boolean(_loc2_[7]) && Boolean(_loc2_[7].length) ? _loc2_[7] == "true" : true;
         this._isButton = Boolean(_loc2_[8]) && Boolean(_loc2_[8].length) ? _loc2_[8] == "true" : false;
      }
      ...
      {
         if(param1 is Slot && Boolean(param1.parent))
         {
            Slot(param1).remove();
         }
      }
