package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class XmlUiGridRenderer implements IGridRenderer
   {
      ...
      public function update(param1:*, param2:uint, param3:DisplayObject, param4:Boolean, param5:uint = 0) : void
      {
         ...
         {
            if(UiRootContainer(param3).ready && Boolean(Object(UiRootContainer(param3).uiClass)))
            {
      ...
      private function updateBackground(param1:UiRootContainer, param2:uint) : void
      {
         ...
         if(Boolean(this._bgColor1) || Boolean(this._bgColor2))
         {
...
class WaitingUpdate
{
   ...
   public function WaitingUpdate(param1:*, param2:uint, param3:DisplayObject, param4:Boolean, param5:Boolean)
   {
      super();
      this.data = param1;
