package com.ankamagames.berilia.components
{
   ...
   public class Texture extends GraphicContainer implements FinalizableUIComponent, IRectangle
   {
      ...
      public function getChildDuration() : uint
      {
         ...
         if(_loc2_)
         {
            ...
            while(_loc3_ < _loc2_.numChildren)
            {
               ...
               {
                  _loc1_ = uint(MovieClip(_loc4_).totalFrames);
               }
               _loc3_++;
            }
         }
         else if(this._child is MovieClip)
         {
            ...
            _loc1_ = uint(_loc5_.totalFrames);
         }
         return _loc1_;
      }
      ...
      {
         if(Boolean(this._child) && this._child is DisplayObjectContainer)
         {
      ...
      private function reload() : void
      {
         ...
         if(this._bitmap != null)
         {
            ...
            if(this._dispatchMessages && Berilia.getInstance() && Boolean(Berilia.getInstance().handler))
            {
