package com.ankamagames.berilia.api
{
   ...
   public class UiApi implements IApi
   {
      ...
      private var oldTextureBounds:Rectangle = new Rectangle();
      ...
      public function getModuleList() : Array
      {
         ...
         _loc1_ = _loc1_.concat(UiModuleManager.getInstance().disabledModule);
      ...
      public function endDrag() : void
      {
         ...
         if(Boolean(_loc1_) && _loc1_.data is SlotDragAndDropData)
         {
      ...
      public function buildOrnamentTooltipFrom(param1:Texture, param2:Rectangle) : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc5_.x += -_loc6_.left * _loc7_ + _loc6_.left;
            _loc5_.y += -_loc6_.top * _loc8_ + _loc6_.top;
