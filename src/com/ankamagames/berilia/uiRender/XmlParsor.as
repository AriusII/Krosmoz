package com.ankamagames.berilia.uiRender
{
   ...
   public class XmlParsor extends EventDispatcher
   {
      ...
      private var _loader:IResourceLoader = ResourceLoaderFactory.getLoader(ResourceLoaderType.PARALLEL_LOADER);
      
      private var _describeType:Function = DescribeTypeCache.typeDescription;
      ...
      {
         if(Boolean(this._xmlDoc) && Boolean(this._xmlDoc.firstChild))
         {
      ...
      protected function parseGraphicElement(param1:XMLNode, param2:XMLNode = null, param3:BasicElement = null) : BasicElement
      {
         ...
         for(_loc8_ in param2.attributes)
         {
            switch(_loc8_)
            {
      ...
      protected function parseAnchors(param1:XMLNode) : Array
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            {
               for(_loc10_ in _loc2_.attributes)
               {
                  switch(_loc10_)
                  {
      ...
      private function suggest(param1:String, param2:Array, param3:uint = 5, param4:uint = 3) : String
      {
         ...
         if(_loc6_.length)
         {
            ...
            {
               _loc5_ += "\"" + _loc6_[_loc8_].word + "\"" + (_loc8_ < _loc6_.length - 1 ? ", " : "");
               _loc8_++;
            }
            if(_loc6_[_loc8_])
            {
               _loc5_ += (!!_loc8_ ? "or " : "") + "\"" + _loc6_[_loc8_].word;
            }
            _loc5_ += "\" ?)";
         }
         return _loc5_;
