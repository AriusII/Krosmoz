         ...
         switch(true)
         {
            case param1 is HumanInputMessage:
               ...
               for each(_loc9_ in this.hierarchy)
               {
                  ...
                  if(!_loc3_ || _loc4_)
                  {
                     _loc10_ = Boolean(UIComponent(_loc9_).process(_loc2_));
                     if(_loc10_)
                     {
            ...
            case param1 is ComponentMessage:
               ...
               if(!_loc7_.canceled)
               {
                  ...
                  while(true)
                  {
                     ...
                     if(Boolean(UIEventManager.getInstance().instances[this.currentDo]) && Boolean(UIEventManager.getInstance().instances[this.currentDo].events[getQualifiedClassName(param1)]))
                     {
