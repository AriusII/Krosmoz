package com.ankamagames.berilia.types.graphic
{
   ...
   public class UiRootContainer extends GraphicContainer
   {
      ...
      public function iAmFinalized(param1:FinalizableUIComponent) : void
      {
         ...
         if(this.uiClass && Boolean(this.uiClass.hasOwnProperty("main")))
         {
            ...
            _log.info("Exec main from " + this.uiClass + "::" + this._uiData.module.id + " : " + (getTimer() - _loc4_) + " ms");
      ...
      public function destroyUi(param1:Object) : void
      {
         ...
         {
            _loc3_ = int(this._aFinalizeElements.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      public function processLocation(param1:GraphicElement) : void
      {
         ...
         if(Boolean(param1.sprite) && Boolean(_loc6_))
         {
      ...
      private function getLocation(param1:Point, param2:GraphicLocation, param3:DisplayObject) : Point
      {
         ...
         {
            case GraphicLocation.REF_PARENT:
               if(Boolean(param3.parent) && Boolean(param3.parent.parent))
               {
      ...
      {
         var _loc3_:uint = param2 == null || param2 is UiRootContainer ? StageShareManager.startWidth : uint(param2.width);
         var _loc4_:uint = param2 == null || param2 is UiRootContainer ? StageShareManager.startHeight : uint(param2.height);
