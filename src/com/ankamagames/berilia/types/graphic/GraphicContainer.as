   ...
   public class GraphicContainer extends Sprite implements UIComponent, IRectangle, Poolable, IDragAndDropHandler, ICustomUnicNameGetter
   {
      ...
      override public function set width(param1:Number) : void
      {
         ...
         if(_loc2_)
         {
            ...
            if(Boolean(_loc3_) && _loc2_.ready)
            {
      ...
      public function get anchorY() : Number
      {
         ...
         if(_loc1_)
         {
            ...
            if(Boolean(_loc2_) && _loc1_.ready)
            {
      ...
      public function set shadowColor(param1:int) : void
      {
         if(Berilia.getInstance().options.uiShadows)
         {
            ...
            else if(param1 == -1 && Boolean(this._shadow))
            {
               this._shadow = null;
               filters = [];
            }
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         if(param1 is MouseClickMessage && Boolean(this._sLinkedTo))
         {
            _loc2_ = this.getUi();
            if(_loc2_ != null)
            {
      ...
      public function getUi() : UiRootContainer
      {
         ...
         {
            if(_loc1_ is GraphicContainer && Boolean(GraphicContainer(_loc1_)._uiRootContainer))
            {
      ...
      private function defaultDropValidatorFunction(param1:*, param2:*, param3:*) : Boolean
      {
         ...
         while(true)
         {
            ...
            if(!(!(_loc4_ is IDragAndDropHandler) && Boolean(_loc4_.parent)))
            {
               break;
            }
         }
      ...
      private function defaultRemoveDropSourceFunction(param1:*) : void
      {
         ...
         while(!(_loc2_ is IDragAndDropHandler) && Boolean(_loc2_.parent));
      ...
      override public function localToGlobal(param1:Point) : Point
      {
         ...
         {
            _loc3_.x += _loc2_.parent.x;
            _loc3_.y += _loc2_.parent.y;
            _loc2_ = _loc2_.parent;
         }
         return _loc3_;
      }
