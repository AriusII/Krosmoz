package com.ankamagames.berilia.types.shortcut
{
   ...
   public class Shortcut implements IDataCenter
   {
      ...
      public function Shortcut(param1:String, param2:Boolean = false, param3:String = null, param4:ShortcutCategory = null, param5:Boolean = true, param6:Boolean = true, param7:Boolean = false, param8:String = null)
      {
         super();
         ...
         if(_loc1_)
         {
            if(_loc1_ is Array)
            {
               ...
               while(_loc7_ < _loc8_)
               {
                  ...
                  {
                     _loc12_ = int(_loc10_.indexOf(_loc4_.category.name));
                     if(_loc12_ == -1)
                     {
