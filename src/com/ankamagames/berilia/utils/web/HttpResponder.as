package com.ankamagames.berilia.utils.web
{
   ...
   public class HttpResponder
   {
      ...
      public function HttpResponder(param1:Socket, param2:String, param3:String, param4:String)
      {
         ...
         if(_loc5_.exists)
         {
            ...
            if(_loc6_.exists)
            {
               ...
               {
                  trace(_loc6_.nativePath);
                  _loc7_ = _loc6_.modificationDate;
                  this._dateHeader = "Date: " + this.toRFC802(_loc7_);
      ...
      private function onDirectoryList(param1:FileListEvent) : void
      {
         ...
         _loc2_ += "<table><tr><td></td><td><b>Name</b></td><td><b>Last modified</b></td><td><b>Size (octet)</b></td></tr>";
         if(this.getRelativePath(File(param1.target)) != "")
         {
            _loc2_ += "<tr><td>" + this.getImg(File(param1.target).parent) + "</td><td><a href=\"" + HttpServer.getInstance().getUrlTo(this.getRelativePath(File(param1.target).parent)) + "\">..</a></td><td>-</td><td>-</td></tr>";
         }
         for each(_loc3_ in param1.files)
         {
            _loc4_ = Boolean(_loc3_.isDirectory);
            _loc2_ += "<tr>" + "<td>" + this.getImg(_loc3_) + "</td>" + "<td><a href=\"" + HttpServer.getInstance().getUrlTo(this.getRelativePath(_loc3_)) + "\">" + _loc3_.name + (_loc4_ ? "/" : "") + "</a></td>" + "<td>" + this.toRFC802(_loc3_.modificationDate) + "</td>" + "<td>" + (_loc4_ ? "-" : _loc3_.size) + "</td>" + "</tr>";
         }
         _loc2_ += "</table></body></html>";
         this._contentBytes = new ByteArray();
      ...
      private function throw404() : void
      {
         ...
         this._mimeHeader = "Content-Type: text/html";
         this._contentBytes = new ByteArray();
         this._contentBytes.writeUTFBytes("<HTML><HEAD><TITLE>404 Not Found</TITLE></HEAD><BODY>404 Not Found</BODY></HTML>");
         this._contentBytes.position = 0;
         this._contentLengthHeader = "Content-Length: " + this._contentBytes.bytesAvailable;
         this.sendResponse();
      }
      ...
      private function throw403() : void
      {
         ...
         this._mimeHeader = "Content-Type: text/html";
         this._contentBytes = new ByteArray();
         this._contentBytes.writeUTFBytes("<HTML><HEAD><TITLE>403 Forbidden</TITLE></HEAD><BODY>403 Forbidden</BODY></HTML>");
         this._contentBytes.position = 0;
         this._contentLengthHeader = "Content-Length: " + this._contentBytes.bytesAvailable;
         this.sendResponse();
      }
      ...
      private function toRFC802(param1:Date) : String
      {
         ...
         _loc2_ += " ";
         _loc2_ += param1.fullYearUTC + " ";
         if(param1.hoursUTC < 10)
         {
            _loc2_ += "0";
         }
         _loc2_ += param1.hoursUTC + ":";
         if(param1.minutesUTC < 10)
         {
            _loc2_ += "0";
         }
         _loc2_ += param1.minutesUTC + ":";
         if(param1.seconds < 10)
         {
            _loc2_ += "0";
         }
         return _loc2_ + (param1.secondsUTC + " GMT");
      }
   }
}
