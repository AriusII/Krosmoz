package com.ankamagames.tiphon.types.look
{
   public class EntityLookParser
   {
      ...
      public static function toString(param1:TiphonEntityLook) : String
      {
         ...
         var _loc2_:* = "{";
         _loc2_ += param1.getBone().toString(DEFAULT_NUMBER_BASE);
         _loc2_ += "|";
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc10_ in _loc3_)
            {
               if(!(_loc8_++ == 0 && param1.defaultSkin != -1))
               {
                  ...
                  _loc2_ += _loc10_.toString(DEFAULT_NUMBER_BASE);
               }
            }
         }
         _loc2_ += "|";
         ...
         if(_loc4_ != null)
         {
            ...
            for(_loc12_ in _loc4_)
            {
               ...
               _loc2_ += uint(_loc12_).toString(DEFAULT_NUMBER_BASE) + "=" + uint(_loc4_[_loc12_]).toString(DEFAULT_NUMBER_BASE);
            }
         }
         _loc2_ += "|";
         ...
         {
            _loc2_ += Math.round(_loc5_ * 100).toString(DEFAULT_NUMBER_BASE);
            if(_loc6_ != _loc5_)
            {
               _loc2_ += "," + Math.round(_loc6_ * 100).toString(DEFAULT_NUMBER_BASE);
            }
         }
         _loc2_ += "|";
         ...
         if(_loc7_ != null)
         {
            ...
            for(_loc14_ in _loc7_)
            {
               for(_loc15_ in _loc7_[_loc14_])
               {
                  ...
                  _loc2_ += uint(_loc14_).toString(DEFAULT_NUMBER_BASE) + "@" + uint(_loc15_).toString(DEFAULT_NUMBER_BASE) + "=" + _loc16_.toString();
               }
            }
         }
