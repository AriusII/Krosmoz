package com.ankamagames.tiphon.engine
{
   ...
   public class TiphonEventsManager
   {
      ...
      public static function addListener(param1:IFLAEventHandler, param2:String) : void
      {
         ...
         var _loc3_:int = -1;
         var _loc4_:int = int(_listeners.length);
         while(++_loc3_ < _loc4_)
         {
      ...
      {
         var _loc2_:int = int(TiphonEventsManager._listeners.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      public function parseLabels(param1:Scene, param2:String) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc3_:int = int(param1.labels.length);
         var _loc4_:int = -1;
         while(++_loc4_ < _loc3_)
         {
      ...
      public function destroy() : void
      {
         ...
         {
            _loc1_ = -1;
            _loc2_ = int(this._events.length);
            while(++_loc1_ < _loc2_)
            {
