package com.ankamagames.tiphon.engine
{
   ...
   public class BoneIndexManager extends EventDispatcher
   {
      ...
      public function hasTransition(param1:uint, param2:String, param3:String, param4:uint) : Boolean
      {
         ...
         return Boolean(this._transitions[param1]) && (this._transitions[param1][param2 + "_" + param3 + "_" + param4] != null || this._transitions[param1][param2 + "_" + param3 + "_" + TiphonUtility.getFlipDirection(param4)] != null);
      }
      ...
      {
         return Boolean(this._index[param1]) && Boolean(this._index[param1][param2]);
      }
