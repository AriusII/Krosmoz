package com.ankamagames.tiphon.display
{
   ...
   public class TiphonSprite extends Sprite implements IAnimated, IAnimationSpriteHandler, IDestroyable, EntityLookObserver
   {
      ...
      public function TiphonSprite(param1:TiphonEntityLook)
      {
         ...
         {
            _loc8_ = int(_loc5_);
            _loc2_ = int(_loc4_[_loc8_].length);
            _loc9_ = 0;
            while(_loc9_ < _loc2_)
            {
      ...
      private function onLoadComplete(param1:TiphonEvent) : void
      {
      ...
      public function restartAnimation(param1:int = -1) : void
      {
         ...
         if(Boolean(this._animMovieClip) && Boolean(_loc2_))
         {
            if(param1 != -1)
            {
               this._animMovieClip.gotoAndStop(param1);
      ...
      {
         return this._currentDirection > 0 ? uint(this._currentDirection) : 0;
      }
      ...
      public function setAnimationAndDirection(param1:String, param2:uint, param3:Boolean = false) : void
      {
         ...
         if(!this.overrideNextAnimation && _loc4_.animation == this._currentAnimation && param2 == this._currentDirection)
         {
            if(Boolean(this._animMovieClip) && this._animMovieClip.totalFrames > 1)
            {
               this.restartAnimation();
            }
      ...
      public function setView(param1:String) : void
      {
         ...
         if(_loc2_)
         {
            if(this.mask != null && Boolean(this.mask.parent))
            {
      ...
      public function updateFromParentEntity(param1:TiphonSprite, param2:BehaviorData) : void
      {
         ...
         while(_loc5_ < 8)
         {
            _loc3_ = Boolean(_loc4_[_loc5_]) || _loc3_;
            _loc5_++;
         }
      ...
      public function destroy() : void
      {
         ...
         try
         {
            if(!this.destroyed)
            {
               ...
               {
                  i = -1;
                  num = int(this._subEntitiesList.length);
                  while(++i < num)
                  {
                     subEntity = this._subEntitiesList[i] as TiphonSprite;
                     if(subEntity)
                     {
                        isCarriedEntity = Boolean(this._aSubEntities["3"]) && subEntity == this._aSubEntities["3"]["0"];
               ...
               {
                  i = -1;
                  num = int(this._subEntitiesTemp.length);
                  while(++i < num)
                  {
      ...
      public function hasAnimation(param1:String, param2:int = -1) : Boolean
      {
         ...
         if(!_loc3_ && Boolean(this._look.getSubEntity(2,0)))
         {
      ...
      {
         var _loc2_:uint = 0;
         if(Boolean(numChildren) && Boolean(this._animMovieClip))
         {
            _loc2_ = 0;
      ...
      public function addSubEntity(param1:DisplayObject, param2:uint, param3:uint) : void
      {
         ...
         if(this._rendered)
         {
            ...
            if(this._recursiveAlternativeSkinIndex && Boolean(_loc4_))
            {
      ...
      public function removeSubEntity(param1:DisplayObject) : void
      {
         ...
         _loc4_ = int(this._subEntitiesList.indexOf(param1));
         if(_loc4_ != -1)
         {
      ...
      public function getSubEntitySlot(param1:uint, param2:uint) : DisplayObjectContainer
      {
         ...
         if(Boolean(this._aSubEntities[param1]) && Boolean(this._aSubEntities[param1][param2]))
         {
      ...
      {
         if(this._rendered && Boolean(this._background[param1]))
         {
      ...
      public function showOnlyBackground(param1:Boolean) : void
      {
         ...
         else if(!param1 && Boolean(this._animMovieClip))
         {
      ...
      public function setAlternativeSkinIndex(param1:int = -1, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = -1;
            _loc4_ = int(this._subEntitiesList.length);
            while(++_loc3_ < _loc4_)
            {
      ...
      public function getGlobalScale() : Number
      {
         ...
         while(_loc2_)
         {
            _loc1_ *= !!_loc2_._animMovieClip ? _loc2_._animMovieClip.scaleX : 1;
      ...
      {
         var _loc2_:ColoredSprite = null;
         if(this._customColoredParts[param1])
         {
            for each(_loc2_ in this._customColoredParts[param1])
            {
      ...
      private function resetSubEntities() : void
      {
         ...
         while(this._subEntitiesList.length)
         {
            ...
            if((Boolean(_loc4_)) && !(this._carriedEntity && _loc4_ == this._carriedEntity))
            {
               if(Boolean(this._aSubEntities["2"]) && Boolean(this._aSubEntities["2"]["0"]) && _loc4_ == this._aSubEntities["2"]["0"])
               {
                  if(this._deactivatedSubEntityCategory.indexOf("2") != -1 && Boolean(_loc4_.carriedEntity))
                  {
         ...
         for(_loc3_ in _loc2_)
         {
            ...
            {
               if(_loc3_ == "2" && Boolean(this._carriedEntity))
               {
               ...
               for(_loc5_ in _loc2_[_loc3_])
               {
                  ...
                  if(parseInt(_loc3_) == 2 && parseInt(_loc5_) == 0 && Boolean(_loc1_))
                  {
      ...
      private function render() : void
      {
         ...
         var _loc14_:int = 0;
         var _loc15_:RasterizedSyncAnimation = null;
         var _loc16_:Sprite = null;
         var _loc17_:Rectangle = null;
         var _loc18_:SubEntityTempInfo = null;
         ...
         if(this.parentSprite)
         {
            ...
            {
               _loc3_ = int(TiphonUtility.getFlipDirection(_loc3_));
            }
         }
         ...
         if(_loc1_ == null)
         {
            ...
            _loc14_ = int(this._currentAnimation.indexOf("Carrying"));
            if(!_loc13_ && _loc14_ != -1)
            {
               _loc13_ = this._currentAnimation.substring(0,_loc14_);
            }
            if(Boolean(_loc13_) && this._currentAnimation != _loc13_)
            {
         ...
         var _loc6_:int = -1;
         if(this._currentAnimation == this._lastClassName && Boolean(this._animMovieClip))
         {
         ...
         else
         {
            ...
            _loc15_ = new RasterizedSyncAnimation(this._animMovieClip,this._lookCode);
            FpsControler.controlFps(_loc15_,_loc2_.frameRate);
            _loc15_.addEventListener(AnimationEvent.EVENT,this.animEventHandler);
            _loc15_.addEventListener(AnimationEvent.ANIM,this.animSwitchHandler);
            if(!this._backgroundOnly)
            {
               this.addChild(_loc15_);
            }
            this._animMovieClip = _loc15_;
         }
         if(!_loc9_ && _loc6_ != -1)
         {
         ...
         var _loc10_:int = int(this._backgroundTemp.length);
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            _loc16_ = this._backgroundTemp.shift();
            if(this._backgroundTemp.shift())
            {
               _loc17_ = this.getRect(this);
               _loc16_.y = _loc17_.y - 10;
            }
            addChildAt(_loc16_,0);
            _loc11_ += 2;
         }
         FpsManager.getInstance().stopTracking("animation");
         if(this._subEntitiesTemp)
         {
            ...
            {
               _loc18_ = this._subEntitiesTemp.shift();
               _loc19_ = _loc18_.entity as TiphonSprite;
               if((Boolean(_loc19_)) && !_loc19_._currentAnimation)
               {
                  _loc19_._currentAnimation = this._currentAnimation;
               }
               this.addSubEntity(_loc18_.entity,_loc18_.category,_loc18_.slot);
            }
         }
      ...
      public function forceRender() : void
      {
         ...
         if(Boolean(this.parentSprite) && this.getGlobalScale() < 0)
         {
            _loc1_ = int(TiphonUtility.getFlipDirection(_loc1_));
         }
      ...
      protected function clearAnimation() : void
      {
         ...
         if(this._animMovieClip)
         {
            ...
            if(this._useCacheIfPossible && Boolean((this._animMovieClip as MovieClip).inCache))
            {
      ...
      override public function dispatchEvent(param1:Event) : Boolean
      {
         ...
         if(param1.type == TiphonEvent.ANIMATION_END && Boolean(this._targetAnimation))
         {
      ...
      private function updateScale() : void
      {
         ...
         while(_loc3_.parent)
         {
            _loc1_ *= _loc3_.parent.scaleX >= 0 ? 1 : -1;
            _loc2_ *= _loc3_.parent.scaleY >= 0 ? 1 : -1;
      ...
      public function onAnimationEvent(param1:String, param2:String = "") : void
      {
         ...
         if(param1 != TiphonEvent.PLAYER_STOP && Boolean(this.parentSprite))
         {
      ...
      {
         this._libReady = true;
         var _loc1_:TiphonEvent = new TiphonEvent(TiphonEvent.SPRITE_INIT,this);
         if(this._init)
         {
            this.dispatchEvent(_loc1_);
         }
      ...
      protected function onAdded(param1:Event) : void
      {
         ...
         if(this._isCarrying && Boolean(this._carriedEntity))
         {
            if(_loc3_)
            {
