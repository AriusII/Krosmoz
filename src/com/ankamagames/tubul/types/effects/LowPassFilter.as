package com.ankamagames.tubul.types.effects
{
   ...
   public class LowPassFilter implements IEffect
   {
      ...
      public function process(param1:Number) : Number
      {
         ...
         this._poleLVel *= this._resonance;
         this._poleLVel += (param1 - this._poleLVal) * _loc4_;
         this._poleLVal += this._poleLVel;
         this._poleRVel *= this._resonance;
         this._poleRVel += (param1 - this._poleRVal) * _loc4_;
         this._poleRVal += this._poleRVel;
