package com.ankamagames.tubul.types
{
   ...
   public class PlayList extends EventDispatcher
   {
      ...
      public function get playingSoundIndex() : int
      {
         ...
         if(this._isPlaying)
         {
            return uint(this._sounds.indexOf(this._playingSound));
         }
         return -1;
      }
      ...
      public function removeSoundBySoundId(param1:String, param2:Boolean = true) : uint
      {
         ...
         for each(_loc3_ in this._sounds)
         {
            ...
            {
               _loc4_ = int(this._sounds.indexOf(_loc3_));
               if(_loc4_ != -1)
               {
                  if(_loc3_.isPlaying)
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param2 && Boolean(this._playingSound))
         {
         ...
         else
         {
            ...
            {
               _loc3_ = int(this._sounds.indexOf(this._playingSound));
