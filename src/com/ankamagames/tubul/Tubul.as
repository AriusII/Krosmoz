package com.ankamagames.tubul
{
   ...
   public class Tubul extends EventDispatcher
   {
      ...
      public function get totalPlayingSounds() : uint
      {
         ...
         {
            _loc1_ += _loc2_.soundList.length;
         }
         return _loc1_;
      }
      ...
      public function removeBus(param1:uint) : void
      {
         ...
         if(this.contains(param1))
         {
            ...
            _loc3_ = int(this._audioBusList.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      public function removeListener(param1:ILocalizedSoundListener) : void
      {
         ...
         var _loc2_:int = int(this._localizedSoundListeners.indexOf(param1));
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      private function onPropertyChanged(param1:PropertyChangeEvent) : void
      {
         ...
         {
            case "muteMusic":
               this.setVolumeToBus(0,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeMusic));
               break;
            case "muteSound":
               this.setVolumeToBus(4,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeSound));
               break;
            case "muteAmbientSound":
               this.setVolumeToBus(1,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(2,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(3,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(5,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(6,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(7,!!param1.propertyValue ? 0 : uint(this._tuOptions.volumeAmbientSound));
               break;
            case "volumeMusic":
