package com.ankamagames.jerakine.data
{
   ...
   public class I18nFileAccessor
   {
      ...
      public function init(param1:Uri) : void
      {
         ...
         this._textCount = 0;
         var _loc3_:int = int(this._stream.readInt());
         var _loc4_:uint = 0;
         this._stream.position = _loc3_;
         var _loc5_:int = int(this._stream.readInt());
         var _loc9_:uint = 0;
         while(_loc9_ < _loc5_)
         {
            _loc6_ = int(this._stream.readInt());
            _loc8_ = Boolean(this._stream.readBoolean());
            _loc7_ = int(this._stream.readInt());
         ...
         _loc5_ = int(this._stream.readInt());
         while(_loc5_ > 0)
         {
            _loc10_ = uint(this._stream.position);
            _loc11_ = this._stream.readUTF();
            _loc7_ = int(this._stream.readInt());
            ++this._textCount;
            this._textIndexes[_loc11_] = _loc7_;
            _loc5_ -= this._stream.position - _loc10_;
         }
         _loc5_ = int(this._stream.readInt());
         _loc9_ = 0;
         while(_loc5_ > 0)
      ...
      public function getText(param1:int) : String
      {
         ...
         var _loc2_:int = int(this._indexes[param1]);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function getUnDiacriticalText(param1:int) : String
      {
         ...
         var _loc2_:int = int(this._unDiacriticalIndex[param1]);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         return Boolean(this._indexes) && Boolean(this._indexes[param1]);
      }
      ...
      public function getNamedText(param1:String) : String
      {
         ...
         var _loc2_:int = int(this._textIndexes[param1]);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         return Boolean(this._textIndexes) && Boolean(this._textIndexes[param1]);
      }
