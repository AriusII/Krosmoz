   ...
   public class LeakDetectionPanel extends Sprite
   {
      ...
      private function updateParents(param1:List, param2:Object) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc3_ = _loc3_.next, _loc3_ != null);
      ...
      public function updateData() : void
      {
         ...
         {
            _loc2_.update();
            _loc1_ += "<font face=\'Verdana\' size=\'15\' color=\'#" + _loc2_.color.toString(16) + "\' >";
            if(_loc2_.selected)
            {
               _loc1_ += "(*) ";
            }
            _loc1_ += "<a href=\'event:" + _loc2_.name + "\'>[" + _loc2_.name + "]</a> : " + FpsManagerUtils.countKeys(_loc2_.list);
            _loc1_ += "</font>\n";
         }
