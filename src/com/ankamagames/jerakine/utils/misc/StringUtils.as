package com.ankamagames.jerakine.utils.misc
{
   ...
   public class StringUtils
   {
      ...
      public static function replace(param1:String, param2:* = null, param3:* = null) : String
      {
         ...
         var _loc4_:Number = Number(param2.length);
      ...
      public static function concatSameString(param1:String, param2:String) : String
      {
         ...
         {
            _loc4_ = _loc5_;
            _loc5_ = int(param1.indexOf(param2,_loc4_ + 1));
            if(_loc5_ == _loc3_)
            {
               break;
            }
      ...
      public static function getAllIndexOf(param1:String, param2:String) : Array
      {
         ...
         while(!_loc5_)
         {
            _loc7_ = int(param2.indexOf(param1,_loc6_));
            if(_loc7_ < _loc6_)
            {
               _loc5_ = true;
            }
            ...
            {
               _loc3_.push(_loc7_);
               _loc6_ = uint(_loc7_ + param1.length);
            }
         }
         return _loc3_;
      }
      ...
      private static function getSingleDelimitedText(param1:String, param2:String, param3:String, param4:Boolean = false) : String
      {
         ...
         _loc6_ = uint(_loc7_ + param2.length);
         while(!_loc11_)
         {
            _loc8_ = int(param1.indexOf(param2,_loc6_));
            _loc9_ = int(param1.indexOf(param3,_loc6_));
            if(_loc9_ == -1)
            {
            ...
            {
               _loc10_ += getAllIndexOf(param2,param1.slice(_loc8_ + param2.length,_loc9_)).length;
               _loc6_ = uint(_loc9_ + param2.length);
            }
            else if(_loc10_ > 1)
            {
               _loc6_ = uint(_loc9_ + param3.length);
               _loc10_--;
            }
            else
            {
