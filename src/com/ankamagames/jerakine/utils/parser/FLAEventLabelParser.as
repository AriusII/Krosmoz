package com.ankamagames.jerakine.utils.parser
{
   ...
   public class FLAEventLabelParser
   {
      ...
      public static function buildSoundLabel(param1:Vector.<SoundEventParamWrapper>) : String
      {
         ...
         return PARAM_ID + "=" + _loc2_.join(",") + "; " + PARAM_VOLUME + "=" + _loc3_.join(",") + "; " + PARAM_ROLLOFF + "=" + param1[0].rollOff + "; " + PARAM_BERCEAU_DUREE + "=" + param1[0].berceauDuree + "; " + PARAM_BERCEAU_VOL + "=" + param1[0].berceauVol + "; " + PARAM_BERCEAU_FADE_IN + "=" + param1[0].berceauFadeIn + "; " + PARAM_BERCEAU_FADE_OUT + "=" + param1[0].berceauFadeOut + "; " + PARAM_NO_CUT_SILENCE + "=" + param1[0].noCutSilence;
      }
   }
}
