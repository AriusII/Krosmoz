package com.ankamagames.jerakine.utils.crypto
{
   public class AdvancedMd5
   {
      ...
      public static function rstr2hex(param1:String) : String
      {
         ...
         {
            _loc4_ = Number(param1.charCodeAt(_loc5_));
      ...
      public static function rstr2b64(param1:String) : String
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            while(_loc7_ < 4)
            {
               ...
               {
                  _loc3_ += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(_loc6_ >>> 6 * (3 - _loc7_) & 0x3F);
               }
               _loc7_++;
            }
            _loc5_ += 3;
      ...
      public static function str2rstr_utf8(param1:String) : String
      {
         ...
         while(++_loc3_ < param1.length)
         {
            ...
            _loc5_ = _loc3_ + 1 < param1.length ? Number(param1.charCodeAt(_loc3_ + 1)) : 0;
      ...
      public static function rstr2binl(param1:String) : Array
      {
         ...
         {
            _loc2_[_loc3_ >> 5] |= (param1.charCodeAt(_loc3_ / 8) & 0xFF) << _loc3_ % 32;
            _loc3_ += 8;
         }
         return _loc2_;
      }
