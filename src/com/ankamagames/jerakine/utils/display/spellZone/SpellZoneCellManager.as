package com.ankamagames.jerakine.utils.display.spellZone
{
   ...
   public class SpellZoneCellManager extends Sprite
   {
      ...
      public function show() : void
      {
         ...
         {
            _loc1_ = new Cross(this._spellLevel.minimalRange,this._spellLevel.maximalRange,null);
         }
         else
         {
            _loc1_ = new Lozenge(this._spellLevel.minimalRange,this._spellLevel.maximalRange,null);
         }
      ...
      private function getSpellZone() : IZone
      {
         ...
         {
            if(_loc4_.zoneShape != 0 && _loc4_.zoneSize < _loc2_ && _loc4_.zoneSize > 0 && _loc4_.zoneSize != 63)
            {
         ...
         switch(_loc1_)
         {
            case SpellShapeEnum.X:
               _loc5_ = new Cross(0,_loc2_,null);
               break;
            case SpellShapeEnum.L:
               _loc5_ = _loc6_ = new Line(_loc2_,null);
               break;
            case SpellShapeEnum.T:
               _loc7_ = new Cross(0,_loc2_,null);
            ...
            case SpellShapeEnum.C:
               _loc5_ = new Lozenge(0,_loc2_,null);
               break;
            case SpellShapeEnum.I:
               _loc5_ = new Lozenge(_loc2_,63,null);
               break;
            case SpellShapeEnum.O:
               _loc5_ = new Lozenge(_loc2_,_loc2_,null);
               break;
            case SpellShapeEnum.Q:
               _loc5_ = new Cross(1,_loc2_,null);
               break;
            case SpellShapeEnum.G:
               _loc5_ = new Square(0,_loc2_,null);
               break;
            case SpellShapeEnum.V:
               _loc5_ = new Cone(0,_loc2_,null);
               break;
            case SpellShapeEnum.W:
               _loc8_ = new Square(0,_loc2_,null);
               _loc8_.diagonalFree = true;
               _loc5_ = _loc8_;
               break;
            case SpellShapeEnum.plus:
               _loc9_ = new Cross(0,_loc2_,null);
               _loc9_.diagonal = true;
               _loc5_ = _loc9_;
               break;
            case SpellShapeEnum.sharp:
               _loc9_ = new Cross(1,_loc2_,null);
               _loc9_.diagonal = true;
               _loc5_ = _loc9_;
               break;
            ...
            case SpellShapeEnum.U:
               _loc5_ = new HalfLozenge(0,_loc2_,null);
               break;
            case SpellShapeEnum.A:
               _loc5_ = new Lozenge(0,63,null);
               break;
            case SpellShapeEnum.P:
            default:
               _loc5_ = new Cross(0,0,null);
         }
