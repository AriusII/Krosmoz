package com.ankamagames.jerakine.utils.display
{
   ...
   public class FpsControler
   {
      ...
      public static function uncontrolFps(param1:DisplayObjectContainer, param2:Boolean = true) : void
      {
         ...
         {
            _loc4_ = int(_loc3_.groupId);
            if(_loc4_)
            {
               _loc5_ = new Vector.<MovieClip>();
               _loc6_ = int(_clipList.length);
               _loc7_ = -1;
               while(++_loc7_ < _loc6_)
               {
      ...
      {
         var _loc2_:int = int(_clipList.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      public static function nextFrame() : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc1_:int = int(_clipList.length);
         var _loc2_:int = -1;
         while(++_loc2_ < _loc1_)
         {
            _loc3_ = _clipList[_loc2_];
