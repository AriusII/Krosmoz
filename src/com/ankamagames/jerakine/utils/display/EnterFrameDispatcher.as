package com.ankamagames.jerakine.utils.display
{
   ...
   public class EnterFrameDispatcher
   {
      ...
      public static function addEventListener(param1:Function, param2:String, param3:uint = 4294967295) : void
      {
         ...
         {
            _controledListeners[param1] = new ControledEnterFrameListener(param2,param1,param3 > 0 ? uint(1000 / param3) : 0,_listenerUp ? _currentTime : uint(getTimer()));
            if(!_listenerUp)
            {
      ...
      public static function removeEventListener(param1:Function) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:* = _controledListeners;
      ...
      private static function onEnterFrame(param1:Event) : void
      {
         ...
         {
            _loc3_ = uint(_currentTime - _loc2_.latestChange);
...
class ControledEnterFrameListener
{
   ...
   public function ControledEnterFrameListener(param1:String, param2:Function, param3:uint, param4:uint)
   {
      super();
      this.name = param1;
