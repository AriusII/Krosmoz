package com.ankamagames.jerakine.utils.prng
{
   public class ParkMillerCarta implements PRNG
   {
      ...
      {
         var _loc1_:uint = uint(16807 * (this._seed >> 16));
         var _loc2_:uint = uint(16807 * (this._seed & 0xFFFF) + ((_loc1_ & 0x7FFF) << 16) + (_loc1_ >> 15));
         return this._seed = _loc2_ > 2147483647 ? uint(_loc2_ - 2147483647) : _loc2_;
      }
   }
}
