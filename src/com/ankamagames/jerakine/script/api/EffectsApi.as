package com.ankamagames.jerakine.script.api
{
   ...
   public class EffectsApi
   {
      ...
      public static function CreateGlowFilter(param1:uint = 4278190080, param2:Number = 1, param3:Number = 6, param4:Number = 6, param5:Number = 2, param6:int = 1, param7:Boolean = false, param8:Boolean = false) : GlowFilter
      {
