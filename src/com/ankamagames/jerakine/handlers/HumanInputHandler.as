package com.ankamagames.jerakine.handlers
{
   ...
   public class HumanInputHandler extends MessageDispatcher
   {
      ...
      private function onMouseOver(param1:MouseEvent) : void
      {
         ...
         if(this.debugOver && Boolean(param1.target.parent))
         {
            ...
            {
               _loc7_ += _loc3_.charCodeAt(_loc8_) * 100 * _loc8_;
               _loc8_++;
            }
      ...
      private function onKeyDown(param1:KeyboardEvent) : void
      {
         ...
         if(this._appleDown)
         {
            this._appleKeyboardEvent = param1;
         }
         else
         {
      ...
      private function onKeyUp(param1:KeyboardEvent) : void
      {
         if(this._appleDown)
         {
            if(param1.keyCode == 15 && Boolean(this._appleKeyboardEvent))
            {
