package com.ankamagames.jerakine.types
{
   ...
   public class Uri
   {
      ...
      public function get fileType() : String
      {
         ...
         {
            _loc1_ = int(this._path.lastIndexOf("."));
            _loc2_ = int(this._path.indexOf("?"));
            return this._path.substr(_loc1_ + 1,_loc2_ != -1 ? _loc2_ - _loc1_ - 1 : int.MAX_VALUE);
         }
         return this._subpath.substr(this._subpath.lastIndexOf(".") + 1,this._subpath.indexOf("?") != -1 ? Number(this._subpath.indexOf("?")) : int.MAX_VALUE);
      }
      ...
      public function isSecure() : Boolean
      {
         ...
         try
         {
            ...
            _loc3_ = _loc1_;
            for(; _loc2_.nativePath != _loc1_; _loc3_ += " -> " + _loc2_.nativePath)
            {
