package com.ankamagames.jerakine.network
{
   ...
   public class HttpServerConnection
   {
      ...
      {
         var _loc4_:Number = Number(this._requestTimestamp[param1.toString()]);
         if((Boolean(_loc4_)) && getTimer() - _loc4_ < param3)
         {
            return false;
         }
         if(param2 == null)
      ...
      protected function receive(param1:IDataInput, param2:Uri) : void
      {
         ...
         var _loc3_:uint = uint(param1.bytesAvailable);
         while(param1.bytesAvailable > 0)
         {
            ...
            _loc3_ = uint(param1.bytesAvailable);
            ...
            else if(!this._whiteListCount || Boolean(this._whiteList[Object(_loc4_).constructor]))
            {
