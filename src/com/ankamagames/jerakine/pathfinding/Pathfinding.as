package com.ankamagames.jerakine.pathfinding
{
   ...
   public class Pathfinding
   {
      ...
      private function nearerSquare() : uint
      {
         ...
         var _loc2_:uint = 0;
         var _loc4_:int = -1;
         var _loc5_:int = int(this._openList.length);
         while(++_loc4_ < _loc5_)
         {
      ...
      private function openSquare(param1:int, param2:int, param3:Array, param4:uint, param5:Number, param6:Boolean) : void
      {
         ...
         if(!param6)
         {
            _loc8_ = int(this._openList.length);
            _loc9_ = -1;
            while(++_loc9_ < _loc8_)
            {
                        ...
                        if(this._map.pointMov(_loc5_,_loc3_,this._bAllowTroughEntity,this._previousCellId))
                        {
                           if(!this.isClosed(_loc3_,_loc5_))
                           {
                              ...
                              if(this._bAllowTroughEntity)
                              {
                                 ...
                                 {
                                    _loc7_ += _loc12_.distanceToCell(this._endPoint);
      ...
      private function endPathFrame() : void
      {
         ...
         if(_loc1_)
         {
            ...
            while(this._nowY != this._startY || this._nowX != this._startX)
            {
               ...
               _loc3_ = int(this._mapStatus[this._nowY][this._nowX].parent[0]);
               _loc4_ = int(this._mapStatus[this._nowY][this._nowX].parent[1]);
               this._nowY = _loc3_;
               this._nowX = _loc4_;
            }
            ...
            if(this._allowDiag)
            {
               ...
               while(_loc7_ < _loc2_.length)
               {
                  ...
                  else if(Boolean(_loc2_[_loc7_ + 3]) && MapPoint(_loc2_[_loc7_]).distanceToCell(_loc2_[_loc7_ + 3]) == 2)
                  {
                     _loc8_ = int(_loc2_[_loc7_].x);
                     _loc9_ = int(_loc2_[_loc7_].y);
                     _loc10_ = int(_loc2_[_loc7_ + 3].x);
                     _loc11_ = int(_loc2_[_loc7_ + 3].y);
                  ...
                  else if(Boolean(_loc2_[_loc7_ + 2]) && MapPoint(_loc2_[_loc7_]).distanceToCell(_loc2_[_loc7_ + 2]) == 2)
                  {
                     _loc8_ = int(_loc2_[_loc7_].x);
                     _loc9_ = int(_loc2_[_loc7_].y);
                     _loc10_ = int(_loc2_[_loc7_ + 2].x);
                     _loc11_ = int(_loc2_[_loc7_ + 2].y);
                     _loc12_ = int(_loc2_[_loc7_ + 1].x);
                     _loc13_ = int(_loc2_[_loc7_ + 1].y);
                     ...
                     else if(_loc8_ == _loc10_ && _loc8_ != _loc12_ && this._map.pointWeight(_loc8_,_loc13_) < 2 && this._map.pointMov(_loc8_,_loc13_,this._bAllowTroughEntity,this._previousCellId))
                     {
                     ...
                     else if(_loc9_ == _loc11_ && _loc9_ != _loc13_ && this._map.pointWeight(_loc12_,_loc9_) < 2 && this._map.pointMov(_loc12_,_loc9_,this._bAllowTroughEntity,this._previousCellId))
                     {
