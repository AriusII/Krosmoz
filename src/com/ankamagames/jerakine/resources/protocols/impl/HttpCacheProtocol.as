package com.ankamagames.jerakine.resources.protocols.impl
{
   ...
   public class HttpCacheProtocol implements IProtocol
   {
      ...
      private var _dataLoading:Dictionary = new Dictionary(true);
      ...
      private function loadCacheFile() : void
      {
         ...
         if(Boolean(_loc1_.exists) && Boolean(_loc1_.isDirectory))
         {
            ...
            for each(_loc6_ in _loc7_)
            {
               ...
               {
                  _loc4_ = int(_loc3_.readInt());
                  _loc5_ = int(_loc3_.readInt());
      ...
      private function loadFile(param1:Uri, param2:IResourceObserver, param3:Boolean, param4:Class) : void
      {
         ...
         if(_loc6_.exists)
         {
            ...
            {
               _loc10_ = int(_calcCachedFileData[_loc9_]);
            }
