package com.ankamagames.jerakine.managers
{
   ...
   public class LangManager
   {
      ...
      private function startParsing(param1:Array, param2:String) : void
      {
         ...
         var _loc3_:Boolean = Boolean(this._parseReference[param2]);
      ...
      private function onXmlLoadComplete(param1:ResourceLoadedEvent) : void
      {
         ...
         {
            if(Boolean(_loc2_.clearFile[param1.uri.fileName]) || _loc2_.clearAllFile)
            {
               this.clear(_loc3_);
            }
      ...
      private function onZipFileComplete(param1:ResourceLoadedEvent) : void
      {
         ...
         while(_loc10_ < _loc3_.length)
         {
            ...
            {
               if(Boolean(_loc6_.clearFile[_loc9_.name]) || _loc6_.clearAllFile)
               {
                  this.clear(_loc5_);
               }
               if(Boolean(_loc6_.clearFile[_loc9_.name]) || _loc6_.loadAllFile)
               {
